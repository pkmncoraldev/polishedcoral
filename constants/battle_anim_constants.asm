...
;	const ANIM_OBJ_ROCK_POLISH_5DEG_R_YFLIP
;	const ANIM_OBJ_ROCK_POLISH_45DEG_R_YFLIP
;	const ANIM_OBJ_ROCK_POLISH_85DEG_R_YFLIP
;	const ANIM_OBJ_ROCK_POLISH_5DEG_L_YFLIP
...
;	const BATTLEANIMOAMSET_103           ; needs correcting
;	const BATTLEANIMOAMSET_104           ; needs correcting
;	const BATTLEANIMOAMSET_105           ; needs correcting
;	const BATTLEANIMOAMSET_106           ; needs correcting
;	const BATTLEANIMOAMSET_107           ; needs correcting
;	const BATTLEANIMOAMSET_108           ; needs correcting
;	const BATTLEANIMOAMSET_109           ; needs correcting
;	const BATTLEANIMOAMSET_10A           ; needs correcting
;	const BATTLEANIMOAMSET_10B           ; needs correcting
;	const BATTLEANIMOAMSET_10C           ; needs correcting
;	const BATTLEANIMOAMSET_10D           ; needs correcting
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_BRIGHTER_PINK    ; 31
	const PAL_BTLCUSTOM_DREEPY           ; 32
	const PAL_BTLCUSTOM_COTTON_GUARD     ; 33
	const PAL_BTLCUSTOM_HEAT_BG          ; 34
	const PAL_BTLCUSTOM_ZAP_CANNON       ; 35
