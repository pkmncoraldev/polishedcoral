...
;mart clerks
	const_def
	const PIC_POKEMART_CLERK
	const PIC_REFRESHMENTS_CLERK
	const PIC_BRILLO_MART_CLERK
	const PIC_POLLEN_SHOP_CLERK
	const PIC_MOOMOOS_CLERK
	
	const_def
	const PAL_POKEMART_CLERK_BLUE
	const PAL_POKEMART_CLERK_PURPLE
	const PAL_POKEMART_CLERK_RED
	const PAL_POKEMART_CLERK_BROWN
	const PAL_REFRESHMENTS_CLERK
	const PAL_BRILLO_MART_CLERK
	const PAL_POLLEN_SHOP_CLERK
