...
; see data/sprites/map_objects.asm
	...
	const SPRITEMOVEDATA_UMBRELLA_LEFT        ; 
	const SPRITEMOVEDATA_UMBRELLA_RIGHT       ; 
...
; see engine/map_objects.asm:MapObjectMovementPattern.Pointers
	...
	const SPRITEMOVEFN_UMBRELLA_LEFT         ; 
	const SPRITEMOVEFN_UMBRELLA_RIGHT        ; 
...
; see engine/map_object_action.asm:Pointers445f
	...
	const PERSON_ACTION_UMBRELLA_LEFT   ; 
	const PERSON_ACTION_UMBRELLA_RIGHT  ; 
...
; see data/sprites/facings.asm:Facings
	...
	const FACING_UMBRELLA_LEFT   ; 
	const FACING_UMBRELLA_RIGHT  ; 
