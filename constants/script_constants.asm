...
DEF LAST_TALKED EQU -2
	...
	const VAR_MINIGAMECENTISECONDS	   ; 23
...
; see engine/events/fruit_trees.asm
	const_def 1
	const FRUITTREE_SUNSET_CAPE
	const FRUITTREE_ROUTE_1
	const FRUITTREE_ROUTE_2_1
	const FRUITTREE_ROUTE_3_1
	const FRUITTREE_ROUTE_3_2
	const FRUITTREE_STARGLOW_VALLEY
	const FRUITTREE_ROUTE_4_1
	const FRUITTREE_ROUTE_4_2
	const FRUITTREE_HUNTERS_THICKET
	const FRUITTREE_ROUTE_5_1
	const FRUITTREE_ROUTE_5_2
	const FRUITTREE_ROUTE_5_3
	const FRUITTREE_ROUTE_8_1
	const FRUITTREE_ROUTE_8_2
	const FRUITTREE_EVENTIDE_FOREST
	const FRUITTREE_ROUTE_9
	const FRUITTREE_DODRIO_RANCH
	const FRUITTREE_ROUTE_2_2
	const FRUITTREE_ROUTE_2_3
	const FRUITTREE_ROUTE_2_4
	const FRUITTREE_ROUTE_2_5
	const FRUITTREE_GLINT_GROVE_1
	const FRUITTREE_GLINT_GROVE_2
	const FRUITTREE_ROUTE_21_1
	const FRUITTREE_ROUTE_21_2
	const FRUITTREE_ROUTE_21_3
	const FRUITTREE_ROUTE_26_1
	const FRUITTREE_ROUTE_26_2
	const FRUITTREE_ROUTE_12
	const FRUITTREE_OASIS_1
