...
; see engine/events/fruit_trees.asm
	...
	const FRUITTREE_STARGLOW_VALLEY ; 05
	const FRUITTREE_ROUTE_4			; 06
	const FRUITTREE_HUNTERS_THICKET ; 07
	const FRUITTREE_ROUTE_5_1		; 08
	const FRUITTREE_ROUTE_5_2		; 09
	const FRUITTREE_ROUTE_5_3		; 10
	const FRUITTREE_ROUTE_8_1		; 11
	const FRUITTREE_ROUTE_8_2		; 12
	const FRUITTREE_EVENTIDE_FOREST	; 13
	const FRUITTREE_ROUTE_9			; 14
	const FRUITTREE_DODRIO_RANCH	; 15
