...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0A, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_FOCUS_BLAST
	...
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_3C,  PAL_BATTLE_OB_YELLOW, ANIM_GFX_STARS ; ANIM_OBJ_SMALL_STAR_SWIRL
