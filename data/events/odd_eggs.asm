...
OddEgg1:
	db BULBASAUR
	db NO_ITEM
	db THUNDERSHOCK, CHARM_FEATHER_DANCE, DIZZY_PUNCH, 0
	dw 02048 ; OT ID
	dt 0 ; Exp
	db 0, 0, 0, 0, 0, 0 ; EVs
	db $BB, $BB, $BB ; DVs
...
OddEgg2:
	...
	db BULBASAUR
	db NO_ITEM
	db TACKLE_SCRATCH_POUND, RAGE, FORESIGHT_ODOR_SLEUTH_MIRACLE_EYE, DIZZY_PUNCH
	dw 02560 ; OT ID
	dt 0 ; Exp
	db 0, 0, 0, 0, 0, 0 ; EVs
	db $BB, $BB, $BB ; DVs
	...
	db BULBASAUR
	db NO_ITEM
	db SWEET_KISS, METRONOME, TACKLE_SCRATCH_POUND, DIZZY_PUNCH
	dw 04096 ; OT ID
	dt 0 ; Exp
	db 0, 0, 0, 0, 0, 0 ; EVs
	db $BB, $BB, $BB ; DVs
