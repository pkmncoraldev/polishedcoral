...
; SILVER TEA
	item_attribute 5000, HELD_BERRY, 50, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD TEA
	item_attribute 10000, HELD_BERRY, 50, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SILVER LEAF
	item_attribute 500, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GOLD LEAF
	item_attribute 500, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
