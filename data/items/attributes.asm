...
; FULL HEAL
	item_attribute 600, 0, -1, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL RESTORE
...
; LEMONADE
	item_attribute 375, 0, 70, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO MILK
	item_attribute 800, 0, 100, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; RAGECANDYBAR
	item_attribute 300, 0, -1, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO BREW
	item_attribute 1500, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
...
; OVAL CHARM
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; FLOWER_PETAL
	item_attribute 400, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLOSSOM_TEA
	item_attribute 800, HELD_BERRY, 30, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; PAINTBRUSH
	item_attribute 4000, HELD_PAINTBRUSH, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHERI BERRY
	item_attribute 300, HELD_HEAL_PARALYZE, 1 << PAR, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; CHESTO BERRY
	item_attribute 300, HELD_HEAL_SLEEP, SLP, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; PECHA BERRY
	item_attribute 300, HELD_HEAL_POISON, 1 << PSN, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; RAWST BERRY
	item_attribute 300, HELD_HEAL_BURN, 1 << BRN, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ASPEAR BERRY
	item_attribute 300, HELD_HEAL_FREEZE, 1 << FRZ, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEPPA BERRY
	item_attribute 300, HELD_RESTORE_PP, -1, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ORAN BERRY
	item_attribute 300, HELD_BERRY, 10, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; PERSIM BERRY
	item_attribute 300, HELD_HEAL_CONFUSE, 0, CANT_SELECT, MEDICINE, ITEMMENU_NOUSE, ITEMMENU_PARTY
; LUM BERRY
	item_attribute 300, HELD_HEAL_STATUS, -1, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SITRUS BERRY
	item_attribute 300, HELD_BERRY, 30, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; FIGY BERRY
	item_attribute 300, HELD_BERRY, 50, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SERPSPARILLA
	item_attribute 4000, 0, 150, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; KEY CARD_R
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KEY CARD_B
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KEY CARD_Y
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GOLD COIN
	item_attribute 800, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILVER COIN
	item_attribute 400, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; UNUSED7
...
; COMET_SHARD
	item_attribute 30000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BERRY_JUICE
	item_attribute 500, HELD_BERRY, 20, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SILK SCARF
...
; METAL COAT
	item_attribute 4000, HELD_TYPE_BOOST, STEEL, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; TAPE PLAYER
	item_attribute 0, 0, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_NEW_MENU, ITEMMENU_NOUSE
; LIGHT BALL
	item_attribute 4000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LINK CABLE
	item_attribute 10000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; THICK CLUB
	item_attribute 6000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LUCKY PUNCH
...
; POLLEN POUCH
	item_attribute 0, 0, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; DUBIOUS DOG
	item_attribute 1000, HELD_BERRY, -1, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; ASSAULT VEST
...
; CHLOROPHIAL
	item_attribute 1000, HELD_CHLOROPHIAL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; NUGGET
	item_attribute 10000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BIG NUGGET
...
; SILVER TEA
	item_attribute 6000, HELD_BERRY, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; GOLD TEA
	item_attribute 10000, HELD_GOLD_TEA, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SILVER LEAF
	item_attribute 1000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GOLD LEAF
	item_attribute 2000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; SUNSHINE_TEA
	item_attribute 1400, HELD_BERRY, 60, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; SWEET HONEY
	item_attribute 300, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FLOWER MAIL
