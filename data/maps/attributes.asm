...
;	connection east, Route43, ROUTE_43, 0, 0, 10
	...
	map_attributes Route29, ROUTE_29, $5, 0
	...
	map_attributes Route36, ROUTE_36, $5, 0
	...
	map_attributes PewterCity, PEWTER_CITY, $f, 0

	map_attributes Route2South, ROUTE_2_SOUTH, $f, NORTH | SOUTH | EAST
	connection north, Route2, ROUTE_2, 0, 0, 10
	...
	connection west, GlintGrove, GLINT_GROVE, -2, 10, 26
	...
	map_attributes VioletOutskirts, VIOLET_OUTSKIRTS, $5, 0
	...
	connection east, GlintGrove, GLINT_GROVE, -1, 8, 13
