...
Route5Gate1F_BlockData:
	INCBIN "maps/Route5Gate1F.ablk.lz"
	
Route5Gate2F_BlockData:
	INCBIN "maps/Route5Gate2F.ablk.lz"
...
PlayerHouse2F_BlockData:
	INCBIN "maps/PlayerHouse2F.ablk.lz"

SunsetLighthouse_BlockData:
	INCBIN "maps/SunsetLighthouse.ablk.lz"
...
SunsetCape_BlockData:
	INCBIN "maps/SunsetCape.ablk.lz"

DaybreakVillage_BlockData:
	INCBIN "maps/DaybreakVillage.ablk.lz"

DaybreakPokemonTrainerSchool_BlockData:
	INCBIN "maps/DaybreakPokemonTrainerSchool.ablk.lz"
	
DaybreakGrotto1_BlockData:
	INCBIN "maps/DaybreakGrotto1.ablk.lz"
...
IceCaveIceRockRoom_BlockData:
	INCBIN "maps/IceCaveIceRockRoom.ablk.lz"
...
LusterSkyscraperB1F_BlockData:
	INCBIN "maps/LusterSkyscraperB1F.ablk.lz"
	
LusterSkyscraperPorygonRoom_BlockData:
	INCBIN "maps/LusterSkyscraperPorygonRoom.ablk.lz"
...
SeasideCaveB2F_BlockData:
	INCBIN "maps/SeasideCaveB2F.ablk.lz"
...
ObscuraMuseum3F_BlockData:
	INCBIN "maps/ObscuraMuseum3F.ablk.lz"
	
ObscuraMuseumEmployeeRoom_BlockData:
	INCBIN "maps/ObscuraMuseumEmployeeRoom.ablk.lz"
...
DragonShrineTop_BlockData:
	INCBIN "maps/DragonShrineTop.ablk.lz"
