...
MapGroup15:
	...
	map Route12, TILESET_AIRPORT, ROUTE, ROUTE_12, MUSIC_LUSTER_CITY, 0, PALETTE_AUTO, FISHGROUP_NONE
	map OnwaIntlAirport, TILESET_AIRPORT, ROUTE, ROUTE_12, MUSIC_LUSTER_CITY, 0, PALETTE_AUTO, FISHGROUP_NONE
