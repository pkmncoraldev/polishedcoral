...
MapGroup13:
	...
	map NettBuilding_1F, TILESET_NETT_BUILDING, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup14:
	map Harbor, TILESET_HARBOR, TOWN, EVENTIDE_VILLAGE, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
