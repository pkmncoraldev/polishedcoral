...
MapGroup23:
	map Brightburg, TILESET_STARGLOW, TOWN, BRIGHTBURG, MUSIC_FLICKER_STATION, 0, PALETTE_AUTO, FISHGROUP_NONE
	map BrightPokeCenter, TILESET_POKECENTER, INDOOR, BRIGHTBURG, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrightMart, TILESET_MART, INDOOR, BRIGHTBURG, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrightHouse1, TILESET_HOUSE_1, INDOOR, BRIGHTBURG, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrightHouse2, TILESET_HOUSE_1, INDOOR, BRIGHTBURG, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrightHouse3, TILESET_HOUSE_1, INDOOR, BRIGHTBURG, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrightburgGate, TILESET_GATE, GATE, GATE_LANDMARK, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
