...
MapGroup1:
	...
	map DaybreakGrotto3, TILESET_CAVE, CAVE, CONNECTING_CAVERN, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup17:
	...
	map DesertWastelandOasis, TILESET_DESERT, ROUTE, DESERT_WASTELAND, MUSIC_OASIS, 0, PALETTE_AUTO, FISHGROUP_NONE
