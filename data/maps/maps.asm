...
MapGroup19:
	map Route19, TILESET_HIGHWAY, ROUTE, ROUTE_19, MUSIC_BAR, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
	map Route19Tunnel, TILESET_HIGHWAY, ROUTE, ROUTE_19, MUSIC_BAR, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
