...
MapGroup16:
	map BrilloTown, TILESET_DESERT, FOREST, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
	map BrilloBoatHouse, TILESET_LAB, INDOOR, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloHouse1, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloHouse2, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloHouse3, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloPokeCenter, TILESET_POKECENTER, INDOOR, BRILLO_TOWN, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloMart, TILESET_MART, INDOOR, BRILLO_TOWN, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
