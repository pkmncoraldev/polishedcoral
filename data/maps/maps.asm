...
MapGroup19:
	map FakeRoute1, TILESET_GATE, INDOOR, ROUTE_1, MUSIC_FAKE_ROUTE_1, 0, PALETTE_DAY, FISHGROUP_NONE
	map FakeRoute2, TILESET_GATE, INDOOR, ROUTE_1, MUSIC_FAKE_ROUTE_1, 0, PALETTE_DAY, FISHGROUP_NONE