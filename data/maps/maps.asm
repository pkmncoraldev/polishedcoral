...
MapGroup21:
	map Route14_15Underwater, TILESET_DIVE, GATE, DIVE_LANDMARK, MUSIC_UNDERWATER, 0, PALETTE_NITE, FISHGROUP_SUNBEAM
	map Route13Underwater, TILESET_DIVE, GATE, DIVE_LANDMARK, MUSIC_UNDERWATER, 0, PALETTE_NITE, FISHGROUP_SUNBEAM
	map Route6Underwater, TILESET_DIVE, GATE, DIVE_LANDMARK, MUSIC_UNDERWATER, 0, PALETTE_NITE, FISHGROUP_SUNBEAM
	map CoralReef, TILESET_DIVE, GATE, DIVE_LANDMARK, MUSIC_UNDERWATER, 0, PALETTE_NITE, FISHGROUP_SUNBEAM
