...
MapGroup20:
	...
	map Crossroads, TILESET_HIGHWAY, ROUTE, CROSSROADS, MUSIC_CROSSROADS, 0, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup26:
	map Inn1F, TILESET_SOUTH_BUILDINGS, INDOOR, CROSSROADS, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map Inn2F, TILESET_SOUTH_BUILDINGS, INDOOR, CROSSROADS, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map Inn3F, TILESET_SOUTH_BUILDINGS, INDOOR, CROSSROADS, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map InnElevator, TILESET_NETT_BUILDING, INDOOR, CROSSROADS, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map InnVent, TILESET_SOUTH_BUILDINGS, CAVE, CROSSROADS, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_NITE, FISHGROUP_NONE
