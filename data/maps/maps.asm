...
MapGroup7:
	...
	map SunbeamBikiniContest, TILESET_GLINT, TOWN, SUNBEAM_ISLAND, MUSIC_GSC_GAME_CORNER, 0, PALETTE_AUTO, FISHGROUP_NONE
	...
	map SunbeamGym, TILESET_JUNGLE, INDOOR, SUNBEAM_ISLAND, MUSIC_GYM, 0, PALETTE_AUTO, FISHGROUP_NONE
	map SunbeamGymCave, TILESET_CAVE, CAVE, SUNBEAM_ISLAND, MUSIC_GYM, 0, PALETTE_AUTO, FISHGROUP_NONE

MapGroup8:
	map Route4EventideGate, TILESET_GATE, GATE, ROUTE_4, MUSIC_ROUTE_4, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventideForest, TILESET_SPOOKY, INDOOR, EVENTIDE_FOREST, MUSIC_EVENTIDE, 0, PALETTE_NITE, FISHGROUP_NONE
	map Route9EventideGate, TILESET_GATE, GATE, ROUTE_9, MUSIC_ROUTE_4, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup9:
	...
	map DodrioRanchBarn, TILESET_HOUSE_2, INDOOR, ROUTE_9, MUSIC_ROUTE_4, 0, PALETTE_AUTO, FISHGROUP_NONE
