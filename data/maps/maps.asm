...
MapGroup9:
	...
	map EventideGymSpeechHouse, TILESET_HOUSE_2, INDOOR, EVENTIDE_VILLAGE, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventideSootheBellHouse, TILESET_HOUSE_2, INDOOR, EVENTIDE_VILLAGE, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
