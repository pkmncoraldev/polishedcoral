...
MapGroup22:
	...
	map KomoreVillage, TILESET_AUTUMN, TOWN, KOMORE_VILLAGE, MUSIC_FLICKER_STATION, 0, PALETTE_AUTO, FISHGROUP_NONE
	...
	map KomoreHouse1, TILESET_HOUSE_1, INDOOR, KOMORE_VILLAGE, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map KomoreHouse2, TILESET_HOUSE_1, INDOOR, KOMORE_VILLAGE, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map KomoreHouse3, TILESET_HOUSE_1, INDOOR, KOMORE_VILLAGE, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
	map KomorePokeCenter, TILESET_POKECENTER, INDOOR, KOMORE_VILLAGE, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_NONE
	map KomoreMart, TILESET_MART, INDOOR, KOMORE_VILLAGE, MUSIC_FLICKER_STATION, 0, PALETTE_DAY, FISHGROUP_NONE
