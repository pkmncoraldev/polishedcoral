...
MapGroup1:
	...
	map GlintGrove, TILESET_GROVE, FOREST, GLINT_GROVE, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map GlintGroveDeep, TILESET_GROVE, FOREST, GLINT_GROVE, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map StarglowCavern3F, TILESET_STARGLOW_CAVERN, CAVE, STARGLOW_CAVERN, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map StarglowCavernFossilRoom, TILESET_STARGLOW_CAVERN, CAVE, STARGLOW_CAVERN, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	...
	map LusterSewersB1F, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map LusterSewersB2F, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map LusterSewersValveRoom, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map LusterSewersThroneRoom, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceCaveB1F, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceCaveB2F, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceCaveB3F, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceTempleB1F1, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceTempleB1F2, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceTempleB1F3, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceTempleB2F1, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map IceTempleB2F2, TILESET_ICE_CAVE, CAVE, FROZEN_RUINS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE



MapGroup2:
	map SunsetBay, TILESET_SUNSET, TOWN, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map SunsetCape, TILESET_SUNSET, TOWN, SUNSET_CAPE, MUSIC_SUNSET_BAY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map Route1Gate, TILESET_GATE, GATE, GATE_LANDMARK, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup4:
	...
	map GlintGroveEntrance, TILESET_GLINT, TOWN, GLINT_CITY, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route3East, TILESET_GLINT, ROUTE, ROUTE_3, MUSIC_ROUTE_2, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map Route8, TILESET_GLINT, ROUTE, ROUTE_8, MUSIC_ROUTE_2, 0, PALETTE_AUTO, FISHGROUP_NONE
	...
	map Route8Gate, TILESET_GATE, GATE, GATE_LANDMARK, MUSIC_ROUTE_4, 0, PALETTE_DAY, FISHGROUP_SHORE

MapGroup5:
	map Route3Starglow, TILESET_STARGLOW, ROUTE, ROUTE_3, MUSIC_ROUTE_2, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map StarglowValley, TILESET_STARGLOW, TOWN, STARGLOW_VALLEY, MUSIC_STARGLOW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route4, TILESET_STARGLOW, ROUTE, ROUTE_4, MUSIC_ROUTE_4, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map HuntersThicket, TILESET_STARGLOW, FOREST, HUNTERS_THICKET, MUSIC_ROUTE_4, 0, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup6:
	map Route6, TILESET_SUNSET, ROUTE, ROUTE_6, MUSIC_ROUTE_4, 0, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup7:
	map SunbeamIsland, TILESET_SUNSET, TOWN, SUNBEAM_ISLAND, MUSIC_SUNBEAM_ISLAND, 0, PALETTE_AUTO, FISHGROUP_NONE
	map SunbeamBeach, TILESET_SUNSET, TOWN, SUNBEAM_ISLAND, MUSIC_SUNBEAM_ISLAND, 0, PALETTE_AUTO, FISHGROUP_NONE
	...
	map SunbeamSoftSandHouse, TILESET_HOUSE_1, INDOOR, SUNBEAM_ISLAND, MUSIC_SUNBEAM_ISLAND, 0, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SunbeamJungle, TILESET_JUNGLE, FOREST, SUNBEAM_ISLAND, MUSIC_JUNGLE, 0, PALETTE_AUTO, FISHGROUP_NONE
	map SunbeamJungleCave, TILESET_CAVE, CAVE, SUNBEAM_ISLAND, MUSIC_LAVA, 0, PALETTE_NITE, FISHGROUP_NONE
	map SunbeamJungleDeep, TILESET_JUNGLE, FOREST, SUNBEAM_ISLAND, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup9:
	...
	map EventideGymSpeechHouse, TILESET_HOUSE_2, INDOOR, EVENTIDE_VILLAGE, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventideSootheBellHouse, TILESET_HOUSE_2, INDOOR, EVENTIDE_VILLAGE, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventideBikeShop, TILESET_HOUSE_2, INDOOR, EVENTIDE_VILLAGE, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventidePokeCenter, TILESET_POKECENTER, INDOOR, EVENTIDE_VILLAGE, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map EventideMart, TILESET_MART, INDOOR, EVENTIDE_VILLAGE, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup11:
	...
	map TwinkleGymEntry, TILESET_PLAYER_HOUSE, INDOOR, TWINKLE_TOWN, MUSIC_GYM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map TwinkleGymBlueRoom, TILESET_PLAYER_HOUSE, INDOOR, TWINKLE_TOWN, MUSIC_GYM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map TwinkleGymYellowRoom, TILESET_PLAYER_HOUSE, INDOOR, TWINKLE_TOWN, MUSIC_GYM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map TwinkleGymRedRoom, TILESET_PLAYER_HOUSE, INDOOR, TWINKLE_TOWN, MUSIC_GYM, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup13:
	...
	map LusterPokeCenter, TILESET_POKECENTER, INDOOR, LUSTER_CITY, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMart, TILESET_MART, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMall, TILESET_MALL_1, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallPokeCenter, TILESET_POKECENTER, INDOOR, LUSTER_CITY, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallElectronicsShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallCoffeeShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallSkateShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallSkateTest, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallAntiqueShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallHerbShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallStoneShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallBallShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map LusterMallClothesShop, TILESET_MALL_2, INDOOR, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map Park, TILESET_PARK, TOWN, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map Skatepark, TILESET_PARK, TOWN, LUSTER_CITY, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
