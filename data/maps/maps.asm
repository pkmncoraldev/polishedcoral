...
MapGroup24:
	...
	map ObscuraMuseum1F, TILESET_SOUTH_BUILDINGS, INDOOR, OBSCURA_CITY, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map ObscuraMuseum2F, TILESET_SOUTH_BUILDINGS, INDOOR, OBSCURA_CITY, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
