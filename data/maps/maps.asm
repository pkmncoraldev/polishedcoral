...
MapGroup1:
	...
	map LusterSewersFlooded, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
	map LusterSewersEmpty, TILESET_SEWER, CAVE, LUSTER_SEWERS, MUSIC_LUSTER_SEWER, 0, PALETTE_NITE, FISHGROUP_SHORE
