...
MapGroup17:
	...
	map DesertRoute2, TILESET_DESERT, ROUTE, DESERT_ROUTE, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
	...
	map DesertTemple1, TILESET_DESERT, CAVE, DESERT_ROUTE, MUSIC_OASIS, 0, PALETTE_DAY, FISHGROUP_NONE
