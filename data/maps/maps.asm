...
MapGroup1:
	...
	map DaybreakGrotto1, TILESET_CAVE, CAVE, DAYBREAK_GROTTO, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_NONE
	map DaybreakGrotto2, TILESET_CAVE, CAVE, DAYBREAK_GROTTO, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_NONE
	map GlintGrove, TILESET_GROVE, FOREST, GLINT_GROVE, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_NONE
	map GlintGroveDeep, TILESET_GROVE, FOREST, GLINT_GROVE, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_NONE
	map StarglowCavern1F, TILESET_STARGLOW_CAVERN, CAVE, STARGLOW_CAVERN, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_NONE
	map StarglowCavern2F, TILESET_STARGLOW_CAVERN, CAVE, STARGLOW_CAVERN, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup3:
	...
	map DaybreakMarcusHouse, TILESET_HOUSE_2, INDOOR, DAYBREAK_VILLAGE, MUSIC_EVOLUTION, 0, PALETTE_DAY, FISHGROUP_NONE
	map DaybreakPokeCenter, TILESET_POKECENTER, INDOOR, DAYBREAK_VILLAGE, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_NONE
	map DaybreakAlexHouse, TILESET_HOUSE_2, INDOOR, DAYBREAK_VILLAGE, MUSIC_EVOLUTION, 0, PALETTE_DAY, FISHGROUP_NONE	
