...
MapGroup22:
	...
	map KomoreCommunityCenter, TILESET_HAUNTED, INDOOR, KOMORE_VILLAGE, MUSIC_COMMUNITY_CENTER, 0, PALETTE_AUTO, FISHGROUP_NONE
	map KomoreCommunityCenterLeft, TILESET_HAUNTED, INDOOR, KOMORE_VILLAGE, MUSIC_COMMUNITY_CENTER, 0, PALETTE_NITE, FISHGROUP_NONE
	map KomoreCommunityCenterMiddle, TILESET_HAUNTED, INDOOR, KOMORE_VILLAGE, MUSIC_COMMUNITY_CENTER, 0, PALETTE_NITE, FISHGROUP_NONE
	map KomoreCommunityCenterRight, TILESET_HAUNTED, INDOOR, KOMORE_VILLAGE, MUSIC_COMMUNITY_CENTER, 0, PALETTE_NITE, FISHGROUP_NONE
