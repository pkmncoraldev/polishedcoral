...
MapGroup10:
	...
	map FlickerTrainGraveyard, TILESET_RANCH, TOWN, FLICKER_STATION, MUSIC_GLINT_GROVE, 0, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup11:
	...
	map Route12Tent, TILESET_HOUSE_1, INDOOR, ROUTE_12, MUSIC_LAVA, 0, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup13:
	...
	map Park, TILESET_PARK, TOWN, PARK, MUSIC_LUSTER_CITY, 0, PALETTE_DAY, FISHGROUP_NONE
	map Skatepark, TILESET_PARK, TOWN, PARK, MUSIC_LUSTER_CITY, 0, PALETTE_AUTO, FISHGROUP_NONE
	map ParkGate, TILESET_GATE, GATE, GATE_LANDMARK, MUSIC_LUSTER_CITY, 0, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup16:
	...
	map BrilloHouse1, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloHouse2, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	map BrilloHouse3, TILESET_HOUSE_1, INDOOR, BRILLO_TOWN, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_DAY, FISHGROUP_NONE
	...
	map BrilloGameCorner, TILESET_MART, INDOOR, BRILLO_TOWN, MUSIC_EVENTIDE_VILLAGE, 0, PALETTE_NITE, FISHGROUP_NONE
	map Route12, TILESET_DESERT, ROUTE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
	map Route12North, TILESET_DESERT, ROUTE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_SUNBEAM
	map DesertWasteland1, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland2, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland3, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland4, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland5, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland6, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland7, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland8, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWasteland9, TILESET_DESERT, CAVE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertWastelandOasis, TILESET_DESERT, ROUTE, ROUTE_12, MUSIC_OASIS, 0, PALETTE_AUTO, FISHGROUP_NONE
	map DesertTempleOutside, TILESET_DESERT, ROUTE, ROUTE_12, MUSIC_LAVA, 0, PALETTE_AUTO, FISHGROUP_NONE
