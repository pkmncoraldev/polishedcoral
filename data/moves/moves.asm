...
Moves:: ; 41afb
	...
	move 0,   EFFECT_ALWAYS_HIT,         60, FLYING,    100, 20,   0, PHYSICAL
	...
	move BARRIER_IRON_DEFENSE,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC,   100, 20,   0, STATUS
	...
	move SYNTHESIS_MOONLIGHT_MORNING_SUN, EFFECT_HEALING_LIGHT,       0, GRASS,    100,  5,   0, STATUS
