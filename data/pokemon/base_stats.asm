...
if def(\1_TMNUM)
	if \1_TMNUM < 25
DEF tms1_24 = tms1_24 | (1 << ((\1_TMNUM) - 1))
	elif \1_TMNUM < 49
DEF tms25_48 = tms25_48 | (1 << ((\1_TMNUM) - 1 - 24))
	elif \1_TMNUM < 73
DEF tms49_72 = tms49_72 | (1 << ((\1_TMNUM) - 1 - 48))
	elif \1_TMNUM < 97
DEF tms73_96 = tms73_96 | (1 << ((\1_TMNUM) - 1 - 72))
	elif \1_TMNUM < 113
DEF tms97_112 = tms97_112 | (1 << ((\1_TMNUM) - 1 - 96))
	else
...
rept 3
	db tms1_24 & $ff
DEF tms1_24 = tms1_24 >> 8
endr
rept 3
	db tms25_48 & $ff
DEF tms25_48 = tms25_48 >> 8
endr
rept 3
	db tms49_72 & $ff
DEF tms49_72 = tms49_72 >> 8
endr
rept 3
	db tms73_96 & $ff
DEF tms73_96 = tms73_96 >> 8
endr
rept 2
	db tms97_112 & $ff
DEF tms97_112 = tms97_112 >> 8
endr
ENDM
...
INCLUDE "data/pokemon/base_stats/raticate_rg.asm"
INCLUDE "data/pokemon/base_stats/raichu_a.asm"
INCLUDE "data/pokemon/base_stats/raichu_rg.asm"
...
INCLUDE "data/pokemon/base_stats/exeggutor_rg.asm"
INCLUDE "data/pokemon/base_stats/marowak_a.asm"
INCLUDE "data/pokemon/base_stats/gyarados_rg.asm"
INCLUDE "data/pokemon/base_stats/sunflora_s.asm"
INCLUDE "data/pokemon/base_stats/sunflora_s.asm"
INCLUDE "data/pokemon/base_stats/wooper_p.asm"
INCLUDE "data/pokemon/base_stats/corsola_g.asm"
INCLUDE "data/pokemon/base_stats/slither_wing.asm"
INCLUDE "data/pokemon/base_stats/smeargle.asm"
INCLUDE "data/pokemon/base_stats/smeargle.asm"
INCLUDE "data/pokemon/base_stats/smeargle.asm"
INCLUDE "data/pokemon/base_stats/smeargle.asm"
