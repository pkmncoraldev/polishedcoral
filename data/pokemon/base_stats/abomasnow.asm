	...
	; tmhm
	tmhm STRENGTH, ROCK_SMASH, ICE_PUNCH, RAIN_DANCE, HAIL, CURSE, ROCK_CLIMB, BULLDOZE, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, LIGHT_SCREEN, REFLECT, BLIZZARD, SOLAR_BEAM
	; end
