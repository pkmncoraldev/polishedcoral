	...
	; tmhm
	tmhm ROCK_SMASH, FAKE_OUT, RAIN_DANCE, ROOST, FLY, CHARM, CURSE, SUNNY_DAY, STEEL_WING, BULLDOZE, SAFEGUARD, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, SOLAR_BEAM
	; end
