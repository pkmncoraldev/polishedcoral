	...
	; tmhm
	tmhm STONE_EDGE, PSYCHIC, ICE_BEAM, DOUBLE_TEAM, ENDURE, REST, ATTRACT, RETURN, MUD_SLAP, TOXIC, HEADBUTT, STRENGTH, ROCK_SMASH, FAKE_OUT, RAIN_DANCE, CHARM, HAIL, DIG, CURSE, BULLDOZE, SAFEGUARD, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, LIGHT_SCREEN, REFLECT, BLIZZARD, DESTINY_BOND, GIGA_DRAIN, ZAP_CANNON, ANCIENTPOWER, SANDSTORM, SHADOW_BALL, EARTHQUAKE, SELFDESTRUCT, CALM_MIND
	; end
