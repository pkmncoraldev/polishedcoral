	...
	; tmhm
	tmhm STRENGTH, ROCK_SMASH, FAKE_OUT, FIRE_PUNCH, THUNDERPUNCH, RAIN_DANCE, DIG, CURSE, ROCK_CLIMB, BULLDOZE, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, LIGHT_SCREEN, REFLECT, THUNDER
	; end
