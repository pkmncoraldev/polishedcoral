	...
	; tmhm
	tmhm TOXIC, HIDDEN_POWER, SUNNY_DAY, HONE_CLAWS, HYPER_BEAM, PROTECT, RAIN_DANCE, BULLDOZE, IRON_TAIL, EARTHQUAKE, RETURN, DIG, ROOST, DOUBLE_TEAM, SLUDGE_BOMB, SANDSTORM, SWIFT, SUBSTITUTE, FACADE, REST, ATTRACT, THIEF, STEEL_WING, ROCK_SLIDE, ROCK_SMASH, FALSE_SWIPE, X_SCISSOR, DARK_PULSE, ENDURE, ACROBATICS, POISON_JAB, GIGA_IMPACT, U_TURN, STONE_EDGE, SWORDS_DANCE, CUT, FLY, STRENGTH, AQUA_TAIL, EARTH_POWER, HEADBUTT, KNOCK_OFF, SLEEP_TALK, SWAGGER
	; end
