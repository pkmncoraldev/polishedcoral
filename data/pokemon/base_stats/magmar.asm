	...
	; tmhm
	tmhm STRENGTH, ROCK_SMASH, FAKE_OUT, FIRE_PUNCH, THUNDERPUNCH, CURSE, SUNNY_DAY, ROCK_CLIMB, WILL_O_WISP, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, FIRE_BLAST, TAUNT
	; end
