	...
	; tmhm
	tmhm ROCK_SMASH, FIRE_PUNCH, THUNDERPUNCH, CURSE, SUNNY_DAY, ROCK_CLIMB, BULLDOZE, WILL_O_WISP, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT, SOLAR_BEAM, FIRE_BLAST
	; end
