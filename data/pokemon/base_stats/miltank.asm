	...
	; tmhm
	tmhm STRENGTH, ROCK_SMASH, ICE_PUNCH, FIRE_PUNCH, THUNDERPUNCH, RAIN_DANCE, CHARM, CURSE, SUNNY_DAY, WORK_UP_GROWTH, BULLDOZE, SAFEGUARD, SUBSTITUTE, PROTECT, THUNDER, BLIZZARD, SOLAR_BEAM
	; end
