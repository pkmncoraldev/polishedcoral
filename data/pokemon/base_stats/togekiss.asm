	...
	; tmhm
	tmhm ROCK_SMASH, FAKE_OUT, FALSE_SWIPE, RAIN_DANCE, ROOST, FLY, CHARM, CURSE, SUNNY_DAY, WORK_UP_GROWTH, STEEL_WING, SAFEGUARD, SUBSTITUTE, PROTECT, HYPER_BEAM, GIGA_IMPACT
	; end
