...
NidoranFEvosAttacks:
	...
	db 9, LEER_TAIL_WHIP
	db 13, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 19, DOUBLE_KICK
	db 21, BITE
	db 25, TOXIC_SPIKES
	db 31, POISON_FANG
...
NidorinaEvosAttacks:
	...
	db 1, TACKLE_SCRATCH_POUND
	db 1, LEER_TAIL_WHIP
	db 1, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 20, DOUBLE_KICK
	db 23, BITE
	db 28, TOXIC_SPIKES
	db 35, POISON_FANG
...
ClefairyEvosAttacks:
	...
	db 6, FAIRY_WIND
	db 9, SING_HYPNOSIS
	db 14, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
...
JigglypuffEvosAttacks:
	...
	db 9, FAIRY_WIND
	db 13, DISABLE
	db 17, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 21, ROLLOUT
	db 25, SWEET_KISS
	db 29, REST
	db 33, BODY_SLAM
...
MeowthEvosAttacks:
	...
	db 22, FEINT_ATTACK
	db 25, TAUNT
	db 30, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 33, SLASH
	db 38, NASTY_PLOT
	db 41, SWAGGER
	db 46, NIGHT_SLASH
...
PersianEvosAttacks:
	...
	db 1, FEINT_ATTACK
	db 1, TAUNT
	db 32, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 37, SLASH
	db 44, NASTY_PLOT
	db 49, SWAGGER
	db 56, NIGHT_SLASH
...
PoliwagEvosAttacks:
	...
	db 11, MUD_SLAP
	db 15, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 18, RAIN_DANCE
	db 21, BUBBLE_BEAM
	db 25, BODY_SLAM
	db 28, BELLY_DRUM
...
LedybaEvosAttacks:
	...
	db 12, REFLECT
	db 15, MACH_PUNCH
	db 19, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 22, SIGNAL_BEAM
	db 25, ROOST
	db 29, BATON_PASS
...
LedianEvosAttacks:
	...
	db 1, REFLECT
	db 1, MACH_PUNCH
	db 20, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 24, SIGNAL_BEAM
	db 28, ROOST
	db 32, BATON_PASS
	db 36, AGILITY_ROCK_POLISH
...
HeracrossEvosAttacks:
	...
	db 16, HEADBUTT
	db 19, WORK_UP_GROWTH
	db 25, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 28, BRICK_BREAK
	db 31, PIN_MISSILE
	db 34, THRASH
	db 37, SWORDS_DANCE
...
SneaselEvosAttacks:
	...
	db 10, FEINT_ATTACK
	db 14, ICY_WIND
	db 16, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
...
TeddiursaEvosAttacks:
	...
	db 1, GROWL
	db 1, BITE
	db 8, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 13, FEINT_ATTACK
	db 17, SWAGGER
	db 22, SLASH
	db 26, PLAY_ROUGH
...
CorsolaEvosAttacks:
	...
	db 20, ANCIENTPOWER
	db 23, HEAL_BELL
	db 27, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 29, BARRIER_IRON_DEFENSE_ACID_ARMOR
	db 31, ROCK_BLAST
	db 35, ENDURE
	db 41, POWER_GEM
...
SwabluEvosAttacks:
	...
	db 1, GROWL
	db 4, SING_HYPNOSIS
	db 7, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 10, SAFEGUARD
	db 13, FAIRY_WIND
...
PikipekEvosAttacks:
	...
	db 15, WING_ATTACK
	db 19, ROOST
	db 21, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 25, SCREECH
	db 27, DRILL_PECK
	db 31, BULLET_SEED
...
TrumbeakEvosAttacks:
	...
	db 16, WING_ATTACK
	db 21, ROOST
	db 24, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP
	db 29, SCREECH
	db 32, DRILL_PECK
	db 35, BULLET_SEED
