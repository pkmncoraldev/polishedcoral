...
SquirtleEvosAttacks:
	...
	db 19, BUBBLE_BEAM
	db 22, PROTECT
	db 25, BARRIER_IRON_DEFENSE_ACID_ARMOR
	db 28, SHELL_SMASH
	db 31, DOUBLE_EDGE
	db 34, AQUA_TAIL
	db 37, HYDRO_PUMP
...
PidgeyEvosAttacks:
	...
	db 19, CHARM_FEATHER_DANCE
	db 23, WING_ATTACK
	db 26, AGILITY_ROCK_POLISH
	db 30, ROOST
	db 34, MIRROR_MOVE
	db 37, AIR_SLASH
	db 41, BRAVE_BIRD
...
JigglypuffEvosAttacks:
	...
	db 29, REST
	db 33, BODY_SLAM
	db 37, TRANSFORM_SKETCH_MIMIC_SPLASH_METRO
	db 41, HYPER_VOICE
	db 45, DOUBLE_EDGE
	db 0 ; no more level-up moves
...
ExeggcuteEvosAttacks:
	...
	db 28, POISONPOWDER
	db 32, SLEEP_POWDER
	db 38, SYNTHESIS_MOONLIGHT_MORNING_SUN
	db 45, PSYSHOCK
	db 49, SOLAR_BEAM
	db 0 ; no more level-up moves
...
ChanseyEvosAttacks:
	...
	db 31, SING_HYPNOSIS
	db 35, EGG_BOMB
	db 41, DEFENSE_CURL_HARDEN_WITHDRAW
	db 49, LIGHT_SCREEN
	db 57, DOUBLE_EDGE
	db 0 ; no more level-up moves
...
EeveeEvosAttacks:
	...
	db EVOLVE_LOCATION_SPECIFIC, GLINT_GROVE, SYLVEON
...
BlisseyEvosAttacks:
	...
	db 25, SING_HYPNOSIS
	db 28, EGG_BOMB
	db 33, DEFENSE_CURL_HARDEN_WITHDRAW
	db 40, LIGHT_SCREEN
	db 47, DOUBLE_EDGE
	db 0 ; no more level-up moves
...
DrilburEvosAttacks:
	...
	db  5, RAPID_SPIN
	db  8, MUD_SLAP
	db 12, MULTI_MOVE_FURY_COMET_BARRAGE_SLAP_CANNON
	db 15, METAL_CLAW
	db 19, DIG
	db 21, SHARPEN_HOWL_MEDITATE
	db 26, HORN_ATTACK
	db 29, ROCK_SLIDE
	db 32, SLASH
	db 36, SWORDS_DANCE
...
MareanieEvosAttacks:
	...
	db 10, BITE
	db 15, VENOSHOCK
	db 20, SOFTBOILED_MILK_DRINK_RECOVER
	db 25, PIN_MISSILE
	db 30, TOXIC_SPIKES
	db 35, WATERFALL
	db 40, NASTY_PLOT
...
MimikyuEvosAttacks:
	...
	db 1, WOOD_HAMMER
	db 5, DOUBLE_TEAM
	db 10, CHARM_FEATHER_DANCE
	db 14, HEX
	db 19, TRANSFORM_SKETCH_MIMIC_SPLASH_METRO
	db 23, FEINT_ATTACK
	db 32, SLASH
	db 37, SHADOW_CLAW
	db 41, SWORDS_DANCE
...
DrakloakEvosAttacks:
	...
	db  1, QUICK_ATTACK
	db  1, BITE
	db  6, LOCK_ON_MIND_READER
	db 12, PURSUIT
	db 18, HEX
	db 24, AGILITY_ROCK_POLISH
	db 30, DOUBLE_HIT
	db 36, FURY_CUTTER
	db 42, DRAGON_DANCE
	db 48, DRAGON_CLAW
