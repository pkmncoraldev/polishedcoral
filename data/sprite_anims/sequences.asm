...
; SPRITE_ANIM_INDEX_SLOTS_NUMEL
	db SPRITE_ANIM_FRAMESET_SLOTS_NUMEL, SPRITE_ANIM_SEQ_SLOTS_NUMEL, $07
...
; SPRITE_ANIM_INDEX_TEAL_WALK
	db SPRITE_ANIM_FRAMESET_TEAL_WALK, SPRITE_ANIM_SEQ_NULL, $00
; SPRITE_ANIM_INDEX_PINK_WALK
	db SPRITE_ANIM_FRAMESET_PINK_WALK, SPRITE_ANIM_SEQ_NULL, $00
; SPRITE_ANIM_INDEX_TAPE
	db SPRITE_ANIM_FRAMESET_TAPE, SPRITE_ANIM_SEQ_NULL, $00
