...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_TOP_HALF, 	   	     DOWN,	 PERSON_ACTION_TOP_HALF,		$8e,    $00,    %0000 ; SPRITEMOVEDATA_TOP_HALF
	sprite_movement_data SPRITEMOVEFN_BOTTOM_HALF,    	     DOWN,	 PERSON_ACTION_BOTTOM_HALF,		$8e,    $00,    %0000 ; SPRITEMOVEDATA_BOTTOM_HALF
