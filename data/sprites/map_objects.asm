...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_STRENGTH,              DOWN,   PERSON_ACTION_BIG_DOLL,        	$2e,    $01,    %0000 ; SPRITEMOVEDATA_BIGDOLL
	...
	sprite_movement_data SPRITEMOVEFN_TILE_DOWN,         	 DOWN,   PERSON_ACTION_TILE_DOWN,   		$7c,    $01,    %0000 ; SPRITEMOVEDATA_TILE_DOWN
	sprite_movement_data SPRITEMOVEFN_TILE_UP,         		 UP,  	 PERSON_ACTION_TILE_UP,   			$7c,    $01,    %0000 ; SPRITEMOVEDATA_TILE_UP
	sprite_movement_data SPRITEMOVEFN_TILE_LEFT,         	 LEFT,   PERSON_ACTION_TILE_LEFT,   		$7c,    $01,    %0000 ; SPRITEMOVEDATA_TILE_LEFT
	sprite_movement_data SPRITEMOVEFN_TILE_RIGHT,         	 RIGHT,  PERSON_ACTION_TILE_RIGHT,   		$7c,    $01,    %0000 ; SPRITEMOVEDATA_TILE_RIGHT
	sprite_movement_data SPRITEMOVEFN_TILE_DOWN,         	 DOWN,   PERSON_ACTION_TILE_DOWN,   		$00,    $01,    %0000 ; SPRITEMOVEDATA_TILE_DOWN_SOLID
	sprite_movement_data SPRITEMOVEFN_TILE_UP,         		 UP,  	 PERSON_ACTION_TILE_UP,   			$00,    $01,    %0000 ; SPRITEMOVEDATA_TILE_UP_SOLID
	sprite_movement_data SPRITEMOVEFN_TILE_LEFT,         	 LEFT,   PERSON_ACTION_TILE_LEFT,   		$00,    $01,    %0000 ; SPRITEMOVEDATA_TILE_LEFT_SOLID
	sprite_movement_data SPRITEMOVEFN_TILE_RIGHT,         	 RIGHT,  PERSON_ACTION_TILE_RIGHT,   		$00,    $01,    %0000 ; SPRITEMOVEDATA_TILE_RIGHT_SOLID
	...
	sprite_movement_data SPRITEMOVEFN_BAGGAGE,  		     LEFT,   PERSON_ACTION_STAND,           	$7e,    $00,    %0000 ; SPRITEMOVEDATA_BAGGAGE
	...
	sprite_movement_data SPRITEMOVEFN_TILE_HALFWAY_LEFT,     LEFT,   PERSON_ACTION_TILE_HALFWAY_LEFT,   $00,    $00,    %0000 ; SPRITEMOVEDATA_TILE_HALFWAY_LEFT
	sprite_movement_data SPRITEMOVEFN_TILE_HALFWAY_RIGHT,    RIGHT,  PERSON_ACTION_TILE_HALFWAY_RIGHT,  $00,    $00,    %0000 ; SPRITEMOVEDATA_TILE_HALFWAY_RIGHT
	sprite_movement_data SPRITEMOVEFN_CURSOLA,			     DOWN,   PERSON_ACTION_CURSOLA,  			$00,    $00,    %0000 ; SPRITEMOVEDATA_CURSOLA
	sprite_movement_data SPRITEMOVEFN_LEMONADE,         	 DOWN,   PERSON_ACTION_LEMONADE,         	$7c,    $00,    %0000 ; SPRITEMOVEDATA_LEMONADE
	sprite_movement_data SPRITEMOVEFN_TRACK_PLAYER,          DOWN,   PERSON_ACTION_STAND,           	$00,    $00,    %0000 ; SPRITEMOVEDATA_TRACK_PLAYER
	sprite_movement_data SPRITEMOVEFN_JUKEBOX,               LEFT,   PERSON_ACTION_JUKEBOX,           	$7c,    $00,    %0000 ; SPRITEMOVEDATA_JUKEBOX
	sprite_movement_data SPRITEMOVEFN_FOSSIL_1,   			 DOWN,   PERSON_ACTION_FOSSIL_1,  			$00,    $00,    %0000 ; SPRITEMOVEDATA_FOSSIL_1
	sprite_movement_data SPRITEMOVEFN_FOSSIL_2,   			 DOWN,   PERSON_ACTION_FOSSIL_2,  			$00,    $00,    %0000 ; SPRITEMOVEDATA_FOSSIL_2
	sprite_movement_data SPRITEMOVEFN_PLUME_BOSS,			 DOWN,   PERSON_ACTION_PLUME_BOSS, 			$00,    $00,    %0000 ; SPRITEMOVEDATA_PLUME_BOSS
	sprite_movement_data SPRITEMOVEFN_BILLBOARD_1_L,		 DOWN,   PERSON_ACTION_BILLBOARD_1_L, 		$00,    $00,    %0000 ; SPRITEMOVEDATA_BILLBOARD_1_L
	sprite_movement_data SPRITEMOVEFN_BILLBOARD_1_R,		 DOWN,   PERSON_ACTION_BILLBOARD_1_R, 		$00,    $00,    %0000 ; SPRITEMOVEDATA_BILLBOARD_1_R
	sprite_movement_data SPRITEMOVEFN_BILLBOARD_2_L,		 DOWN,   PERSON_ACTION_BILLBOARD_2_L, 		$00,    $00,    %0000 ; SPRITEMOVEDATA_BILLBOARD_2_L
	sprite_movement_data SPRITEMOVEFN_BILLBOARD_2_R,		 DOWN,   PERSON_ACTION_BILLBOARD_2_R, 		$00,    $00,    %0000 ; SPRITEMOVEDATA_BILLBOARD_2_R
	sprite_movement_data SPRITEMOVEFN_NETT_BALL_L,			 LEFT,   PERSON_ACTION_NETT_BALL_L, 		$7c,    $02,    %0000 ; SPRITEMOVEDATA_NETT_BALL_L
	sprite_movement_data SPRITEMOVEFN_NETT_BALL_R,			 RIGHT,  PERSON_ACTION_NETT_BALL_R, 		$7c,    $02,    %0000 ; SPRITEMOVEDATA_NETT_BALL_R
