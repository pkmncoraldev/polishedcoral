...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_CARD_TABLE_1,	    	 DOWN,   PERSON_ACTION_CARD_TABLE_1,		$00,    $00,    %0000 ; SPRITEMOVEDATA_CARD_TABLE_1
	sprite_movement_data SPRITEMOVEFN_CARD_TABLE_2,	    	 DOWN,   PERSON_ACTION_CARD_TABLE_2,		$00,    $00,    %0000 ; SPRITEMOVEDATA_CARD_TABLE_2
	sprite_movement_data SPRITEMOVEFN_CARD_TABLE_3,	    	 DOWN,   PERSON_ACTION_CARD_TABLE_3,		$00,    $00,    %0000 ; SPRITEMOVEDATA_CARD_TABLE_3
	sprite_movement_data SPRITEMOVEFN_CARD_TABLE_4,	    	 DOWN,   PERSON_ACTION_CARD_TABLE_4,		$00,    $00,    %0000 ; SPRITEMOVEDATA_CARD_TABLE_4
