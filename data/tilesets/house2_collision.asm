	...
	tilecoll FLOOR, CONVEYOR_UP, FLOOR, CONVEYOR_UP ; 6c
	...
	tilecoll CONVEYOR_DOWN, FLOOR, CONVEYOR_DOWN, FLOOR ; 71
	tilecoll CONVEYOR_LEFT, CONVEYOR_LEFT, FLOOR, FLOOR ; 72
	tilecoll CONVEYOR_RIGHT, CONVEYOR_RIGHT, FLOOR, FLOOR ; 73
