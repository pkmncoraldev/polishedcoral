	...
	tilecoll FLOOR, FLOOR, FLOOR, DODRIO_JUMP_NO_RL ; 7d
	tilecoll FLOOR, FLOOR, DODRIO_JUMP_NO_RL, FLOOR ; 7e
	...
	tilecoll LEFT_WALL, FLOOR, LEFT_WALL, FLOOR ; ee
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, LEFT_WALL, FLOOR ; ef
