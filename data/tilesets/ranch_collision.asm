	...
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, LEFT_WALL, FLOOR ; 2c
	...
	tilecoll FLOOR, FLOOR, LEDGE_DOWN, LEDGE_DOWN ; 35
	...
	tilecoll FLOOR, RIGHT_WALL, LEDGE_DOWN, LEDGE_DOWN_RIGHT ; a9
