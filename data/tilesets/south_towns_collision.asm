	...
	tilecoll SKATE, SKATE, SKATE, SKATE ; 90
	...
	tilecoll FLOOR, FLOOR, FLOOR, UP_WALL ; a6
	tilecoll FLOOR, FLOOR, UP_WALL, FLOOR ; a7
	...
	tilecoll FLOOR, FLOOR, HEADBUTT_TREE, FLOOR ; cf
