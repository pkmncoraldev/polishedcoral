...
TrainerClassDVsAndPersonality: ; 270d6
	...
	db 252, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE | PLAIN_FORM   ; rocky
	db 252, PERFECT_DVS,   ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; darcy
	...
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; rose
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; lily
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; iris
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; poppy
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; felicia
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; violet
	db 252, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; clover
	...
	db 100, $BB, $BB, $BB, ABILITY_2 | QUIRKY, MALE | PLAIN_FORM   ; police captain
