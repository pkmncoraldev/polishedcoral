...
TrainerClassDVsAndPersonality: ; 270d6
	...
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; rose
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; lily
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; iris
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; poppy
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; felicia
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; violet
	db 100, PERFECT_DVS, ABILITY_1 | QUIRKY, FEMALE | PLAIN_FORM ; clover
