...
; ================
	...
	db 42, MEGANIUM, NO_ITEM, 125, $d8, $dA, $8d, HIDDEN_ABILITY | CALM, FEMALE
		db LEECH_SEED, CALM_MIND, SOLAR_BEAM, WEATHER_BALL
	db 42, BLISSEY, NO_ITEM, 1, $ee, $ee, $ee, ABILITY_2 | MODEST, FEMALE
		db SING_HYPNOSIS, SOFTBOILED_MILK_DRINK_RECOVER, HYPER_BEAM, CHARM_FEATHER_DANCE
	db 43, SUNFLORA, CHLOROPHIAL, 252, $88, $de, $7d, ABILITY_1 | HARDY, FEMALE | PLAIN_FORM
