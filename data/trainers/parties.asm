...
; ================
	...
	; party
	db 40, VENUSAUR
		db LEECH_SEED, POWER_WHIP, DOUBLE_EDGE, 0	;TODO PETAL BLIZZARD
	db 40, CHARIZARD
...
; ================
	...
	db 32, SMEARGLE, PAINTBRUSH, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE | PINK_FORM
	...
	db MINA_MON_ROUTE_11, 30, MILTANK, LEFTOVERS, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE
		db ROLLOUT, SOFTBOILED_MILK_DRINK_RECOVER, DEFENSE_CURL_HARDEN_WITHDRAW, PLAY_ROUGH
	db MINA_MON_RADIANT_FIELD, 32, WEEZING, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, MALE
		db EXPLOSION, CLEAR_SMOG, SLUDGE_BOMB, DESTINY_BOND
	db MINA_MON_ROUTE_29, 31, MIMIKYU, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE | PLAIN_FORM
	...
	db MINA_MON_ROUTE_10, 32, WIGGLYTUFF, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE
		db ICE_PUNCH, SING_HYPNOSIS, ATTRACT, HYPER_VOICE
	db -1 ; end
