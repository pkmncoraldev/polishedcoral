...
; ================
	...
	db 36, CROBAT, FIGY_BERRY, 1, $A8, $AA, $8A, ABILITY_1 | QUIRKY, FEMALE
		db ROAR_WHIRLWIND, ACROBATICS, CRUNCH, VENOSHOCK
	db 37, PERSIAN, LIFE_ORB, 1, $77, $7A, $77, ABILITY_1 | QUIRKY, FEMALE | ALOLAN_FORM
		db CRUNCH, GUNK_SHOT, NASTY_PLOT, FAKE_OUT
	db 38, SCOLIPEDE, NO_ITEM, 1, $99, $9A, $99, HIDDEN_ABILITY | IMPISH, FEMALE
		db VENOSHOCK, TOXIC, DOUBLE_EDGE, MEGAHORN
	db -1 ; end
...
; ================
	...
	; party
	db 12, VOLTORB
		db TACKLE_SCRATCH_POUND, THUNDERSHOCK, SCREECH, 0
	db 12, MARILL
		db TACKLE_SCRATCH_POUND, WATER_GUN, LEER_TAIL_WHIP, AQUA_JET
	db 12, JIGGLYPUFF
		db SING_HYPNOSIS, TACKLE_SCRATCH_POUND, DEFENSE_CURL_HARDEN_WITHDRAW, FAIRY_WIND
	db -1 ; end
...
; ================
	...
	db MINA_MON_ROUTE_29, 1, CYNDAQUIL, $00, $00, $00, ABILITY_1 | HARDY, MALE
		db TACKLE_SCRATCH_POUND, 0, 0, 0
	db MINA_MON_ROUTE_10, 1, TOTODILE, $00, $00, $00, ABILITY_1 | HARDY, MALE
		db TACKLE_SCRATCH_POUND, 0, 0, 0
	db -1 ; end
