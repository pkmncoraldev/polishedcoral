...
; ================
	...
	db 21, SCYTHER, $77, $77, $77, ABILITY_1 | HARDY, MALE
...
; ================
	...
	db 34, SCYTHER, $88, $88, $88, ABILITY_1 | HARDY, MALE
		db WING_ATTACK, SLASH, PURSUIT, FOCUS_ENERGY
	db 38, SNORUNT, $dd, $dd, $dd, HIDDEN_ABILITY | HARDY, FEMALE
...
; ================
	...
	db 34, SCYTHER, $88, $88, $88, ABILITY_1 | HARDY, MALE
		db WING_ATTACK, SLASH, PURSUIT, FOCUS_ENERGY
	db 38, SNORUNT, $ff, $ff, $ff, HIDDEN_ABILITY | HARDY, FEMALE
		db ICE_SHARD, DOUBLE_TEAM, ICICLE_CRASH, PROTECT
