...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 32, HOUNDOOM, NO_ITEM, 48, $77, $7A, $77, ABILITY_2 | QUIRKY, MALE
		db SUNNY_DAY, FIRE_FANG, BITE, SWAGGER
	db 32, FLOATZEL, NO_ITEM, 48, $77, $7A, $77, HIDDEN_ABILITY | CAREFUL, FEMALE
		db AQUA_JET, SCALD, PURSUIT, DOUBLE_HIT
	db 33, CAMERUPT, HEAT_ROCK, 48, $77, $7A, $77, ABILITY_1 | CALM, MALE
		db SUNNY_DAY, AMNESIA, FLAMETHROWER, REST
	db 36, MAROWAK, NO_ITEM, 48, $77, $7A, $77, HIDDEN_ABILITY | QUIRKY, MALE | ALOLAN_FORM
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 1, WOOPER, NO_ITEM, 1, $77, $7A, $77, ABILITY_1 | QUIRKY, MALE | PALDEAN_FORM
		db TACKLE_SCRATCH_POUND, 0, 0, 0
	db -1 ; end
