...
; ================
	...
	db 32, SMEARGLE, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE
	...
	db MINA_MON_ROUTE_11, 30, MILTANK, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE
	...
	db MINA_MON_ROUTE_29, 31, MIMIKYU, NO_ITEM, $cc, $cc, $cc, ABILITY_1 | HARDY, FEMALE
