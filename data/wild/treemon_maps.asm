...
TreeMonMaps:
	...
	treemon_map ROUTE_23, TREEMONS_SHIMMER
	treemon_map ROUTE_24, TREEMONS_SHIMMER
	treemon_map ROUTE_25, TREEMONS_KOMORE
	treemon_map ROUTE_26_NORTH, TREEMONS_KOMORE
	treemon_map ROUTE_26_SOUTH, TREEMONS_KOMORE
	treemon_map ROUTE_27, TREEMONS_KOMORE
	treemon_map ROUTE_28, TREEMONS_KOMORE
	treemon_map ROUTE_29, TREEMONS_BRIGHT
	treemon_map BRIGHTBURG, TREEMONS_BRIGHT
	treemon_map ROUTE_30, TREEMONS_BRIGHT
	treemon_map ROUTE_31, TREEMONS_BRIGHT
	treemon_map OBSCURA_CITY, TREEMONS_BRIGHT
	treemon_map ROUTE_32, TREEMONS_BRIGHT
	db -1
