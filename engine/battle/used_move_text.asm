...
;	db GYRO_BALL
;	db ENERGY_BALL
;	db PSYSHIELD_BASH                          ; NEEDS UPDATE
;	db GUNK_SHOT
;	db REVERSAL
;	db SLUDGE
;	db ICE_SHARD
...
;	db PERISH_SONG
	...
	db KNOCK_OFF
	db SUPERPOWER                              ; NEEDS UPDATE
	db CROSS_CHOP                              ; NEEDS UPDATE
	db AQUA_JET                                ; NEEDS UPDATE
	db RAIN_DANCE
	db SUNNY_DAY
	db CRUNCH
	db DOUBLE_KICK
	db NASTY_PLOT                               ; NEEDS UPDATE
	db EXTREMESPEED                             ; NEEDS UPDATE
	db ANCIENTPOWER
	db SHADOW_BALL                              ; NEEDS UPDATE
	db FUTURE_SIGHT
	db ROCK_SMASH
	db EGG_BOMB                                 ; NEEDS UPDATE
	db DARK_PULSE                               ; NEEDS UPDATE
	db MOONBLAST                                ; NEEDS UPDATE
	db PLAY_ROUGH
	db CONVERSION2
	db 0
