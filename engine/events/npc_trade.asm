...
TradeIntroText7:
	text_jump UnknownText_TradeIntroText7
	db "@"

TradeCancelText7:
	text_jump UnknownText_TradeCancelText7
	db "@"

TradeWrongText7:
	text_jump UnknownText_TradeWrongText7
	db "@"

TradeCompleteText7:
	text_jump UnknownText_TradeCompleteText7
	db "@"
