...
InitializeEventsScript:
	...
	setevent EVENT_SPRUCELAB_MUNCH4_GONE
	...
	setevent EVENT_OLD_MANOR_DOLL_GONE
	...
	setevent EVENT_RUSS_NOT_HOME
	setevent EVENT_SUNBATHER_BURNT
	setevent EVENT_LUMINA_GYM_CUTSCENE
	setevent EVENT_NETT_KAGE_GONE
	setevent EVENT_NETT_LOCKE_GONE
	setevent EVENT_WELL_ITEM_GONE
	setevent EVENT_WELL_TAPE_GONE
