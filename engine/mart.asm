...
MartClerkPics:
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SUNSET
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_GLINT
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_STARGLOW
	db PIC_REFRESHMENTS_CLERK,		PAL_REFRESHMENTS_CLERK		; MART_ROUTE_5_GATE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LAKE_ONWA
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SUNBEAM
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_EVENTIDE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_FLICKER
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_TWINKLE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_RED	 	; MART_LUSTER_MALL_ELECTRONICS
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_RED	 	; MART_LUSTER_MALL_ELECTRONICS_TM
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_PURPLE	; MART_LUSTER_MALL_COFFEE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_PURPLE	; MART_LUSTER_MALL_COFFEE2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER_MALL_ANTIQUE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER_MALL_HERB
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER_MALL_STONE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER_MALL_CLOTHES
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BROWN 	; MART_LUSTER_MALL_BALL_1
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BROWN 	; MART_LUSTER_MALL_BALL_2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHIMMER_FISH_MARKET
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHIMMER_BERRY_MARKET
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHIMMER
	db PIC_BRILLO_MART_CLERK,		PAL_BRILLO_MART_CLERK 		; MART_BRILLO
	db PIC_BRILLO_MART_CLERK,		PAL_BRILLO_MART_CLERK 		; MART_COINS
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_RADIANT
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_DUSK
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_KOMORE
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_RED	 	; MART_LUSTER_MALL_ELECTRONICS_DECO
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_LUSTER_MALL_FURNITURE
	db PIC_MOOMOOS_CLERK,			PAL_MOOMOOS_CLERK	 		; MART_MOOMOOS_1
	db PIC_MOOMOOS_CLERK,			PAL_MOOMOOS_CLERK	 		; MART_MOOMOOS_2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHIMMER_CAFE
	db PIC_POLLEN_SHOP_CLERK,		PAL_POLLEN_SHOP_CLERK		; MART_POLLEN
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_CELADON_5F_1
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_CELADON_5F_2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SAFFRON
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SILPH_CO
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_FUCHSIA
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHAMOUTI_1
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_SHAMOUTI_2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_BT_1
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_BT_2
	db PIC_POKEMART_CLERK,			PAL_POKEMART_CLERK_BLUE 	; MART_BT_3
