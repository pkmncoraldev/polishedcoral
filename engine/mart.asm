...
MartClerkPics:
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_SUNSET
	...
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_LUSTER_MALL_ANTIQUE
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_LUSTER_MALL_HERB
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_LUSTER_MALL_STONE
	db PIC_FATTY_CLERK,				PAL_FATTY_CLERK_BROWN 		; MART_LUSTER_MALL_CLOTHES
	...
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_SHIMMER_FISH_MARKET
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_SHIMMER_BERRY_MARKET
	...
	db PIC_STANDARD_CLERK,			PAL_STANDARD_CLERK_BLUE 	; MART_SHIMMER_CAFE
