...
.Chris:
	...
	db PLAYER_DODRIO,	 SPRITE_CHRIS;DODRIO_RIDE
	db PLAYER_INVISIBLE, SPRITE_CHRIS;INVISIBLE
	db $ff
...
.Kris:
	...
	db PLAYER_DODRIO,	 SPRITE_KRIS;DODRIO_RIDE
	db PLAYER_INVISIBLE, SPRITE_KRIS;INVISIBLE
	db $ff
; 141c9
