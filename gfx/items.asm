...
ScopeLensIcon:    				INCBIN "gfx/items/scope_lens.2bpp"
...
AssaultVestIcon:  				INCBIN "gfx/items/assault_vest.2bpp"
...
RockyHelmetIcon:  				INCBIN "gfx/items/rocky_helmet.2bpp"
SafeGogglesIcon:  				INCBIN "gfx/items/safety_goggle.2bpp"
...
WideLensIcon:     				INCBIN "gfx/items/wide_lens.2bpp"
WiseGlassesIcon:  				INCBIN "gfx/items/nett_specs.2bpp"
ZoomLensIcon:     				INCBIN "gfx/items/zoom_lens.2bpp"
GoldLeafIcon:
SilverLeafIcon:
MentalHerbIcon:
PowerHerbIcon:
...
HeatRockIcon:
SmoothRockIcon:
IcyRockIcon:      				INCBIN "gfx/items/damp_rock.2bpp"
...
TinyMushroomIcon:    			INCBIN "gfx/items/tinymushroom.2bpp"
BigMushroomIcon:    			INCBIN "gfx/items/big_mushroom.2bpp"
BalmMushroomIcon:    			INCBIN "gfx/items/balmmushroom.2bpp"
BlackPearlIcon:
...
BedIcon:        				INCBIN "gfx/items/misc/bed.2bpp"
RedRugIcon:  					INCBIN "gfx/items/misc/red_rug.2bpp"
BlueRugIcon:  					INCBIN "gfx/items/misc/blue_rug.2bpp"
YellowRugIcon:  				INCBIN "gfx/items/misc/yellow_rug.2bpp"
GreenRugIcon:  					INCBIN "gfx/items/misc/green_rug.2bpp"
MagnaPlantIcon:  				INCBIN "gfx/items/misc/magnaplant.2bpp"
TropicPlantIcon:  				INCBIN "gfx/items/misc/tropicplant.2bpp"
JumboPlantIcon:  				INCBIN "gfx/items/misc/jumboplant.2bpp"
SpikeyPlantIcon:  				INCBIN "gfx/items/misc/spikeyplant.2bpp"
BigSnorlaxIcon:  				INCBIN "gfx/items/misc/big_snorlax.2bpp"
BigLaprasIcon:  				INCBIN "gfx/items/misc/big_lapras.2bpp"
PokeBallPosterIcon: 			INCBIN "gfx/items/misc/pokeball_poster.2bpp"
PikachuPosterIcon: 				INCBIN "gfx/items/misc/pikachu_poster.2bpp"
ClefairyPosterIcon: 			INCBIN "gfx/items/misc/clefairy_poster.2bpp"
JigglypuffPosterIcon: 			INCBIN "gfx/items/misc/jigglypuff_poster.2bpp"
EeveePosterIcon: 				INCBIN "gfx/items/misc/eevee_poster.2bpp"
MarillPosterIcon: 				INCBIN "gfx/items/misc/marill_poster.2bpp"
...
PikachuBuyMonIcon:     			INCBIN "gfx/icons/pikachu.2bpp"
EeveeBuyMonIcon:     			INCBIN "gfx/icons/eevee.2bpp"
ClefairyBuyMonIcon:     		INCBIN "gfx/icons/clefairy.2bpp"
JigglypuffBuyMonIcon:     		INCBIN "gfx/icons/jigglypuff.2bpp"
MeowthBuyMonIcon:     			INCBIN "gfx/icons/meowth.2bpp"
MinccinoBuyMonIcon:     		INCBIN "gfx/icons/minccino.2bpp"
MarillBuyMonIcon:     			INCBIN "gfx/icons/marill.2bpp"
TeddiursaBuyMonIcon:     		INCBIN "gfx/icons/teddiursa.2bpp"
CottoneeBuyMonIcon:     		INCBIN "gfx/icons/cottonee.2bpp"
