...
BusinessmanPic: 		  INCBIN "gfx/trainers/businessman.2bpp.lz"
...
Sunflora_SFrontpic:      INCBIN "gfx/pokemon/sunflora_s/front.2bpp.lz"
Sunflora_IntroFrontpic:      INCBIN "gfx/pokemon/sunflora_s/intro.2bpp.lz"
...
DarcyPic:                 INCBIN "gfx/trainers/darcy.2bpp.lz"
WillPic:
KogaPic:
BrunoPic:
KarenPic:
...
PoliceCaptainPic:         INCBIN "gfx/trainers/police_captain.2bpp.lz"
