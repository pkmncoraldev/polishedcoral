AureoleMountain4F_MapScriptHeader:
	...
	smashrock_outside_event  8, 22
	person_event SPRITE_HIKER, 20,  4, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_GENERICTRAINER, 1, AureoleMountain4F_Trainer, -1
