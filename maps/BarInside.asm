BarInside_MapScriptHeader:
	...
	person_event SPRITE_JUKEBOX,  5,  8, SPRITEMOVEDATA_JUKEBOX, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, BarInsideJukebox, -1
	person_event SPRITE_JUKEBOX,  0,  4, SPRITEMOVEDATA_TILE_UP_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_HIDE_OW_OBJECTS_TEAL
	person_event SPRITE_JUKEBOX,  0,  4, SPRITEMOVEDATA_TILE_UP_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_HIDE_OW_OBJECTS_PURPLE
