BrightMart_MapScriptHeader:
	...
	person_event SPRITE_CLERK,  3, 1, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightMartClerk, EVENT_BRIGHTBURG_REVEALED
	person_event SPRITE_SUPER_NERD,  6,  6, SPRITEMOVEDATA_WANDER, 1, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightMartClerk, EVENT_BRIGHTBURG_REVEALED
	person_event SPRITE_REDS_MOM,  2,  9, SPRITEMOVEDATA_WANDER, 1, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightMartNPC, EVENT_BRIGHTBURG_REVEALED
