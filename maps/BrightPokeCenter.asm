BrightPokeCenter_MapScriptHeader:
	...
	person_event SPRITE_BOWING_NURSE,  1, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterNurse, EVENT_BRIGHTBURG_REVEALED
	person_event SPRITE_CHANSEY,  1, 6, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterChansey, EVENT_BRIGHTBURG_REVEALED
	person_event SPRITE_OTTO,  6,  9, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterNPC1, EVENT_BRIGHTBURG_REVEALED
	person_event SPRITE_TOGEPI,  5, 9, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterChansey, EVENT_BRIGHTBURG_REVEALED
	...
	person_event SPRITE_PONYTAIL,  3, 7, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterNurse, EVENT_BRIGHTBURG_REVEALED
	pc_nurse_event  5, 1
