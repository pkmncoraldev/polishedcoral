BrightPokeCenter_MapScriptHeader:
	...
	person_event SPRITE_PONYTAIL,  2, 11, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, BrightPokeCenterNurse, EVENT_BRIGHTBURG_REVEALED
	pc_nurse_event  4, 1
