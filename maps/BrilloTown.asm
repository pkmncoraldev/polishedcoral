BrilloTown_MapScriptHeader:
	...
	object_event 25, 12, SPRITE_SINGER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, BrilloSinger, -1
	object_event 26, 12, SPRITE_SINGER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, BrilloSinger, -1
	object_event 27, 12, SPRITE_SINGER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, BrilloSinger, -1
	...
	tmhmball_event 14,  4, TM_SANDSTORM, EVENT_TM37
