ConnectingCavern_MapScriptHeader:
	...
	warp_event 27, 45, SEASIDE_CAVE_B1F, 4
	...
	bg_event 22, 24, SIGNPOST_ITEM + RARE_CANDY, EVENT_CONNECTING_CAVERN_HIDDEN_RARE_CANDY
	bg_event 37, 25, SIGNPOST_ITEM + MAX_REVIVE, EVENT_CONNECTING_CAVERN_HIDDEN_MAX_REVIVE
	...
	person_event SPRITE_POKEMANIAC, 41, 35, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, TrainerConnectingCavern_4, -1
	person_event SPRITE_POKEMANIAC, 23, 23, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 2, TrainerConnectingCavern_5, -1
