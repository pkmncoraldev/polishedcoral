ConnectingCavern_MapScriptHeader:
	...
	person_event SPRITE_PSYCHIC, 41, 35, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, TrainerConnectingCavern_4, -1
	person_event SPRITE_PSYCHIC, 23, 23, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 2, TrainerConnectingCavern_5, -1
