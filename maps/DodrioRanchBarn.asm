DodrioRanchBarn_MapScriptHeader:
	...
	object_event  5,  2, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, DODUO, -1, -1, PAL_NPC_BROWN, PERSONTYPE_SCRIPT, 0, RanchDoduo, -1
	object_event  1,  2, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, DODUO, -1, -1, PAL_NPC_BROWN, PERSONTYPE_SCRIPT, 0, RanchDoduo, -1
	person_event SPRITE_ROCKER,  5,  7, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, RanchBarnNPC, -1
	itemball_event  0,  4, SHARP_BEAK, 1, EVENT_DODRIO_RANCH_BARN_POKE_BALL
