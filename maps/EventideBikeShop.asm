EventideBikeShop_MapScriptHeader:
	...
	db 3 ; object events
	person_event SPRITE_COOL_DUDE,  2,  7, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, EventideBikeShopOwner, EVENT_HAVENT_SAVED_BIKESHOP_OWNERS_SON
	...
	person_event SPRITE_COOL_DUDE,  4,  4, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, EventideBikeShopOwnerNpc, EVENT_SAVED_BIKESHOP_OWNERS_SON
