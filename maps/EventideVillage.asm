EventideVillage_MapScriptHeader:
	...
	person_event SPRITE_LASS, 17, 28, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, EventideVillageNPC2, EVENT_EVENTIDE_LASS_GONE
	person_event SPRITE_BUG_CATCHER, 29, 10, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, EventideVillageNPC3, -1
