FlickerPass1F_MapScriptHeader:
	...
	tmhmball_event 19, 22, TM_HAIL, EVENT_FLICKER_PASS_1F_POKEBALL_HAIL
	...
	person_event SPRITE_HIKER, 22, 32, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_GENERICTRAINER, 3, TrainerFlickerPass1F_2, -1
