FlickerPass2F_MapScriptHeader:
	...
	bg_event 18, 19, SIGNPOST_ITEM + POTION, EVENT_FLICKER_PASS_2F_HIDDEN_ITEM_3

	db 11 ; object events
	itemball_event   3, 27, POTION, 1, EVENT_FLICKER_PASS_2F_POKEBALL_1
	itemball_event  27, 36, POTION, 1, EVENT_FLICKER_PASS_2F_POKEBALL_2
	person_event SPRITE_POKEMANIAC, 33, 14, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 2, TrainerFlickerPass2F_1, -1
