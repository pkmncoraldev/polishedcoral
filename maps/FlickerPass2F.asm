FlickerPass2F_MapScriptHeader:
	...
	person_event SPRITE_BOARDER, 10, 18, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_GENERICTRAINER, 1, TrainerFlickerPass2F_3, -1
	...
	person_event SPRITE_FIREBREATHER, 22, 43, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 1, TrainerFlickerPass2F_5, -1
