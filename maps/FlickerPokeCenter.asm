FlickerPokeCenter_MapScriptHeader:
	...
	warp_def 7, 6, 1, FLICKER_STATION
	...
	person_event SPRITE_POKEFAN_F, 4, 2, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, FlickerCenterNPC2, -1
