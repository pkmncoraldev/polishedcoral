FlickerStation_MapScriptHeader:
	...
	warp_def 11, 47, 1, FLICKER_SOUND_SPEECH_HOUSE
	warp_def 11, 59, 1, FLICKER_NAME_SPEECH_HOUSE
	...
	person_event SPRITE_YOUNGSTER, 12, 41, SPRITEMOVEDATA_WANDER, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, FlickerStationNPC5, -1
