GlintApartmentRight1F_MapScriptHeader:
	...
	person_event SPRITE_CHILD, 4, 6, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, GlintApt21FNpc3, -1
...
GlintApt21FNpc3Text:
	text "When I grow up,"
	line "I wanna be just"
	cont "like ANDRE!"
	
	para "He was the last"
	line "#MON LEAGUE"
	cont "CHAMPION."
