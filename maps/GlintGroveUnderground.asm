GlintGroveUnderground_MapScriptHeader:
	...
	db 3 ; warp events
	warp_def  7, 31, 1, GLINT_GROVE_EAST
	...
	tmhmball_event 35, 27, TM_DAZZLINGLEAM, EVENT_TM49
	tapeball_event  8, 40, MUSIC_WILD_BOSS_BATTLE, 2, EVENT_MUSIC_WILD_BOSS_BATTLE
	itemball_event 27, 15, STAR_PIECE, 1, EVENT_GLINT_GROVE_UNDERGROUND_STAR_PIECE_1
	itemball_event 37, 21, STAR_PIECE, 1, EVENT_GLINT_GROVE_UNDERGROUND_STAR_PIECE_2
	itemball_event 17, 37, COMET_SHARD, 1, EVENT_GLINT_GROVE_UNDERGROUND_COMET_SHARD
