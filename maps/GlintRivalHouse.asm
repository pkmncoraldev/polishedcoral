GlintRivalHouse_MapScriptHeader:
	...
	db 2 ; object events
	person_event SPRITE_POKEFAN_F, 3, 2, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, GlintRivalHouseMom, -1
