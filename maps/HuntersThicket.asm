HuntersThicket_MapScriptHeader:
	...
	itemball_event 45, 16, PP_MAX, 1, EVENT_HUNTERS_THICKET_BALL_4
	itemball_event 30, 10, MAX_POTION, 1, EVENT_HUNTERS_THICKET_BALL_5
	itemball_event 39,  5, ULTRA_BALL, 1, EVENT_HUNTERS_THICKET_BALL_6
