KomoreHouse1_MapScriptHeader:
	...
	db 2 ; warp events
	warp_event  2,  6, KOMORE_VILLAGE, 3
	warp_event  3,  6, KOMORE_VILLAGE, 3
	...
	object_event  6,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STANDING_DOWN, 0, GIRAFARIG, -1, -1, PAL_NPC_PINK, PERSONTYPE_SCRIPT, 0, KomoreHouse3Giraf, EVENT_DECO_GIRAFARIG_DOLL
