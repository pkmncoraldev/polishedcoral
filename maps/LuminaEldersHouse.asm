LuminaEldersHouse_MapScriptHeader:
	...
	person_event SPRITE_DARCY,  4,  6, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, LuminaEldersHouseDarcy, EVENT_LUMINA_ELDERS_HOUSE_DARCY_GONE
	...
	person_event SPRITE_DARCY,  3,  2, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, LuminaEldersHouseDarcy2, EVENT_LUMINA_ELDERS_HOUSE_DARCY_GONE_2
