LusterApartment5_2F_MapScriptHeader:
	...
	person_event SPRITE_DELINQUENT_F,  3,  7, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, LusterApartment5_2F_NPC2, -1
	person_event SPRITE_SUPER_NERD,  5,  0, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, LusterApartment5_2F_NPC3, -1
