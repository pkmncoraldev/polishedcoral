LusterCityResidential_MapScriptHeader:
	...
	signpost  0,  0, SIGNPOST_READ, LusterEmptyApartment
	...
	person_event SPRITE_YOUNGSTER, 23, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Luster1NPC4, -1
	...
	object_event 14, 23, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, PIKACHU, -1, -1, PAL_NPC_BROWN, PERSONTYPE_SCRIPT, 0, Luster1NPC11, -1
	...
	person_event SPRITE_CUTE_GIRL, 26,  7, SPRITEMOVEDATA_WANDER, 1, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, Luster1NPC13, -1
