LusterCityShopping_MapScriptHeader:
	...
	person_event SPRITE_LASS, 36, 11, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, Luster2NPC1, -1
	person_event SPRITE_LASS, 36, 10, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, Luster2NPC2, -1
	person_event SPRITE_CHILD, 36, 12, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Luster2NPC3, -1
	person_event SPRITE_LASS, 46, 14, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, Luster2NPC4, -1
	person_event SPRITE_PONYTAIL, 33, 20, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, Luster2NPC5, -1
	...
	person_event SPRITE_BEAUTY, 34, 15, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_TRAINER, 3, Luster2BankCardNPC, EVENT_GOT_BANK_CARD
...
Luster2BankCardNPC:
	trainer PLAYER_CORA, -1, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_8, -1, -1, 0, LusterTalkToBankCardGirlScript
	
LusterTalkToBankCardGirlScript:
	farscall TalkToBankCardGirlScript
	end
