LusterMallCoffeeShop_MapScriptHeader:
	...
	person_event SPRITE_CLERK, -5, -5, SPRITEMOVEDATA_STANDING_DOWN, 0, 1, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, LusterMallCoffeeShop_Cook, -1
	...
	person_event SPRITE_DAISY,  5,  7, SPRITEMOVEDATA_STANDING_RIGHT, 0, 1, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, LusterMallCoffeeShop_NPC2, -1
	...
	person_event SPRITE_POLLY,  3,  7, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, LusterMallCoffeeShopPolly, EVENT_POLLY_NOT_IN_KOFFING_BEAN
...
LusterMallCoffeeShop_NPC1Text6:
	text "I'll teach the"
	line "baristas here how"
	cont "to make that tea."
