LusterMallHerbShop_MapScriptHeader:
	...
	db 3 ; object events
	object_event  6,  4, SPRITE_CUTE_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_COMMAND, pokemart, MARTTYPE_STANDARD, MART_LUSTER_MALL_HERB, -1
