LusterSewersB2F_MapScriptHeader:
	...
	person_event SPRITE_BURGLAR, 17,  1, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, LusterSewerShadyGuy1, EVENT_LUSTER_SEWERS_FLOODED
	person_event SPRITE_BURGLAR, 15,  8, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, LusterSewerShadyGuy2, EVENT_LUSTER_SEWERS_EMPTY
