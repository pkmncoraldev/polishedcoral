LusterSewersMukRoom_MapScriptHeader:
	...
	person_event SPRITE_GRIMER_A_OW,  6,  7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, LusterSewersMukRoomGrimer2, EVENT_MT_ONWA_CUTSCENE
	...
	person_event SPRITE_GRIMER_A_OW,  6,  8, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, LusterSewersMukRoomGrimer3, EVENT_MT_ONWA_CUTSCENE
