LusterSewersThroneRoom_MapScriptHeader:
	...
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	person_event SPRITE_PLAYER_CUTSCENE,  7,  5, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, -1, EVENT_MT_ONWA_CUTSCENE
	...
	const LUSTERSEWERSTHRONEROOM_CUTSCENE1
	const LUSTERSEWERSTHRONEROOM_CUTSCENE2
	const LUSTERSEWERSTHRONEROOM_CUTSCENE3
	const LUSTERSEWERSTHRONEROOM_CUTSCENE4
	const LUSTERSEWERSTHRONEROOM_CUTSCENE5
	const LUSTERSEWERSTHRONEROOM_CUTSCENE6
	const LUSTERSEWERSTHRONEROOM_CUTSCENE7
...
LusterSewersThroneRoomFrankieCutscene:
	...
	if_equal 6, .pink
.red:	
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE1
	jump .cont

.blue
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE2
	jump .cont

.green
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE3
	jump .cont
	
.brown
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE4
	jump .cont
	
.purple
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE5
	jump .cont
	
.teal
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE6
	jump .cont
	
.pink
	appear LUSTERSEWERSTHRONEROOM_CUTSCENE7
...
.cont
	...
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE1
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE2
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE3
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE4
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE5
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE6
	disappear LUSTERSEWERSTHRONEROOM_CUTSCENE7
	pause 10
