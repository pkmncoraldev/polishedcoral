LusterSewersValveRoom1_MapScriptHeader:
	db 0 ; scene scripts
	...
	db 2 ; object events
	person_event SPRITE_VALVE_1,  1,  3, SPRITEMOVEDATA_VALVE, 2, 2, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, LusterSewersValveRoom1Valve, -1
	person_event SPRITE_VALVE_2,  1,  3, SPRITEMOVEDATA_VALVE, 2, 2, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, LusterSewersValveRoom1Valve, -1

	const_def 1 ; object constants
	const LUSTER_SEWERS_VALVE_ROOM_1_VALVE_1
	const LUSTER_SEWERS_VALVE_ROOM_1_VALVE_2
	
LusterSewersValveRoom1Valve:
	opentext
	...
	closetext
	pause 3
	disappear LUSTER_SEWERS_VALVE_ROOM_1_VALVE_1
	playsound SFX_SQUEAK
	pause 14
	closetext
	appear LUSTER_SEWERS_VALVE_ROOM_1_VALVE_1
	closetext
	pause 14
	closetext
	disappear LUSTER_SEWERS_VALVE_ROOM_1_VALVE_1
