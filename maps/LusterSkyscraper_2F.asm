LusterSkyscraper_2F_MapScriptHeader:
	db 0 ; scene scripts
	...
	db 7 ; object events
	person_event SPRITE_POKEMANIAC, 7, 0, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, LusterSkyscraper_2F_NPC1, -1
	person_event SPRITE_POKEMANIAC, 7, 6, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, LusterSkyscraper_2F_NPC2, -1
	...
	const LUSTER_SKYSCRAPER_2F_NPC_1
	const LUSTER_SKYSCRAPER_2F_NPC_2
	const LUSTER_SKYSCRAPER_2F_TRADE
	
	
LusterSkyscraper_2F_NPC1:
	faceplayer
	opentext
	writetext LusterSkyscraper_2F_NPC1Text
	waitbutton
	closetext
	spriteface LUSTER_SKYSCRAPER_2F_NPC_1, UP
	setevent EVENT_CAN_GO_TO_SKYCRAPER_BASEMENT
	end
	
LusterSkyscraper_2F_NPC2:
