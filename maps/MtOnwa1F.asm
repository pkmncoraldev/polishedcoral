MtOnwa1F_MapScriptHeader:
	...
	warp_def  1, 19, 2, MT_ONWA_CLIFF
	warp_def  5, 21, 10, MT_ONWA_1F
	warp_def 14, 27, 9, MT_ONWA_1F
	warp_def  1, 11, 1, MT_ONWA_LOWER_CLIFF

	db 0 ; coord events

	db 3 ; bg events
	bg_event 16, 12, SIGNPOST_ITEM + NUGGET, EVENT_MT_ONWA_1F_HIDDEN_NUGGET
	bg_event 11, 22, SIGNPOST_ITEM + ULTRA_BALL, EVENT_MT_ONWA_1F_HIDDEN_ULTRA_BALL
	...
	person_event SPRITE_JUGGLER, 13, 22, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, TrainerMtOnwa_5, -1
	person_event SPRITE_HIKER, 11,  4, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_GENERICTRAINER, 1, TrainerMtOnwa_6, -1
	person_event SPRITE_POKEMANIAC, -1, -1, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 4, TrainerMtOnwa_7, -1
