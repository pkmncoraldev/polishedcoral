MtOnwaB1F_MapScriptHeader:
	...
	db 8 ; object events
	tmhmball_event  2, 4, TM_FIRE_PUNCH, 1, EVENT_MT_ONWA_B1F_POKE_BALL_1
	itemball_event 32, 7, RARE_CANDY, 1, EVENT_MT_ONWA_B1F_POKE_BALL_2
	itemball_event 10,18, BURN_HEAL, 1, EVENT_MT_ONWA_B1F_POKE_BALL_3
...
LavaCaveBF1Trainer2:
	generictrainer FIREBREATHER, FRITZ, EVENT_BEAT_MT_ONWA_B1F_TRAINER_1, .SeenText, .BeatenText
...
LavaCaveBF1Trainer3:
	generictrainer FIREBREATHER, MEL, EVENT_BEAT_MT_ONWA_B1F_TRAINER_1, .SeenText, .BeatenText
