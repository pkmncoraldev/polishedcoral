NettBuildingOffice_MapScriptHeader:
	...
	db 4 ; object events
	person_event SPRITE_POKEMANIAC,  3,  5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, NettBuildingOfficeNett, EVENT_NETT_BUILDING_DUNGEON
