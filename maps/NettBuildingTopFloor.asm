NettBuildingTopFloor_MapScriptHeader:
	...
	person_event SPRITE_RECEPTIONIST,  2,  9, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, NettBuildingTopFloor_NPC_2, EVENT_NETT_OFFICE_ELI_GONE
