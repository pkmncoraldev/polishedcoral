ObscuraCity_MapScriptHeader:
	...
	db 2 ; bg events
	signpost 14, 18, SIGNPOST_JUMPTEXT, ObscuraCityMuseumSign
	signpost  9, 26, SIGNPOST_JUMPTEXT, ObscuraCityMuseumBackSign
	...
	person_event SPRITE_POKEMANIAC, 14, 16, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_OBSCURA_CITY_ROCKY_GONE
	person_event SPRITE_COOLTRAINER_F, 19, 16, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ALWAYS_SET
