ObscuraMuseum3F_MapScriptHeader:
	...
	person_event SPRITE_RAINBOW_SILVER_WING, 10,  7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, ObscuraMuseum3FRainbowWing, -1
	person_event SPRITE_RAINBOW_SILVER_WING, 10, 10, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, ObscuraMuseum3FSilverWing, EVENT_HIDE_OW_OBJECTS_PURPLE
	person_event SPRITE_RAINBOW_SILVER_WING, 10, 10, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, ObscuraMuseum3FSilverWing, EVENT_HIDE_OW_OBJECTS_TEAL
