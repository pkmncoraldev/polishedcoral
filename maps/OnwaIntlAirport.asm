OnwaIntlAirport_MapScriptHeader:
	...
	db 16 ; object events
	person_event SPRITE_POKEMANIAC,  0, 33, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, OnwaIntlAirportNPC1, -1
	...
	tmhmball_event 33, -2, TM_STEEL_WING, EVENT_TM47
	itemball_event  6, 10, PP_UP, 1, EVENT_AIRPORT_POKE_BALL_2
