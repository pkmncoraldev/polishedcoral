...
;	powergap
	...
	object_event  3,  1, SPRITE_BIG_DOLL, SPRITEMOVEDATA_BIGDOLL, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BigDoll, EVENT_KRISS_HOUSE_2F_BIG_DOLL
	object_event  2,  2, SPRITE_BIG_DOLL, SPRITEMOVEDATA_NO_RENDER, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BigDoll, EVENT_KRISS_HOUSE_2F_BIG_DOLL
	...
	const PLAYERHOUSE2F_BIG_DOLL_DUMMY_1
	const PLAYERHOUSE2F_BIG_DOLL_DUMMY_2
...
;	setevent EVENT_DECO_BIG_MUK_DOLL
	...
	setevent EVENT_DECO_MINCCINO_DOLL
