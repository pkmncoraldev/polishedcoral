RadiantField_MapScriptHeader:
	...
	person_event SPRITE_PICNIC, 27, 15, SPRITEMOVEDATA_TILE_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, RadiantFieldPicnic, -1 ;EVENT_RADIANT_FIELD_MINA_GONE
