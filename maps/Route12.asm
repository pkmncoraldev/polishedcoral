Route12_MapScriptHeader:
	...
	db 1 ; callbacks
	callback MAPCALLBACK_TILES, Route12ChangeBlocks
	...
	db 17 ; object events
	person_event SPRITE_COOLTRAINER_M,  7, 24, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 4, TrainerRoute12_1, EVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_COOLTRAINER_F, 16, 11, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 4, TrainerRoute12_2, EVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_BIKER, 18, 22, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, TrainerRoute12_3, EVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_COOLTRAINER_M,  7, 24, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 4, TrainerRoute12_1_2, EVENT_HAVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_COOLTRAINER_F, 16, 11, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 4, TrainerRoute12_2_2, EVENT_HAVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_BIKER, 18, 22, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, TrainerRoute12_3_2, EVENT_HAVENT_MADE_IT_TO_SOUTH_ONWA
	person_event SPRITE_ENGINEER, 22, 13, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route12NPC1, EVENT_MADE_IT_TO_SOUTH_ONWA
	...
	person_event SPRITE_ENGINEER, 20, 11, SPRITEMOVEDATA_STANDING_DOWN, 1, 1, -1, -1, (1 << 3) | PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, Route12NPC2, -1
...
Route12ChangeBlocks:
	...
	iffalse .end
	changemap Route12Bridge_BlockData
	moveperson 11, $0a, $14
.end
	return
...
Route12NPC2:
	...
	writetext Route12NPC2Text1Boy2
	jump .cont
.no_bridge_boy
...
.girl
	...
	writetext Route12NPC2Text1Girl2
	jump .cont
.no_bridge_girl
