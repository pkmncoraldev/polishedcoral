Route13_MapScriptHeader:
	...
	person_event SPRITE_TUBER, 15, 14, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_GENERICTRAINER, 1, TrainerRoute13_5, -1
	...
	tapeball_event  7,  8, MUSIC_GSC_GAME_CORNER, 1, EVENT_MUSIC_GSC_GAME_CORNER
