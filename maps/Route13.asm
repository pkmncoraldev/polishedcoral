Route13_MapScriptHeader:
	...
	person_event SPRITE_BIKINI_2,  6, 47, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_GENERICTRAINER, 3, TrainerRoute13_4, -1
	...
	person_event SPRITE_BIKINI_2,  6, 67, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, ObjectEvent, -1
	itemball_event 65,  4, SUPER_POTION, 1, EVENT_ROUTE_6_SUPER_POTION
