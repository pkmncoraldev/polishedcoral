Route19_MapScriptHeader:
	...
	db 4 ; warp events
	warp_event 41, 42, ROUTE_19_DUSK_GATE, 1
	warp_event 41, 43, ROUTE_19_DUSK_GATE, 2
	warp_event 22,  9, SEASIDE_CAVE_1F, 1
	warp_event 27, 29, ROUTE_22_TUNNEL, 7

	db 0 ; coord events

	db 2 ; bg events
	signpost 23,  6, SIGNPOST_JUMPTEXT, Route19Sign1Text
	signpost 30, 25, SIGNPOST_JUMPTEXT, Route19Sign2Text

	db 9 ; object events
	person_event SPRITE_PIGTAILS, 36, 21, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, Route19Clover, EVENT_SAVED_CLOVER
	person_event SPRITE_SKATER, 24, 18, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route19Skater1, -1
	person_event SPRITE_SKATER, 24, 13, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 1, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, Route19Skater2, -1
	person_event SPRITE_SAILOR, 27,  8, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, Route19Trainer1, -1
	person_event SPRITE_SCHOOLBOY, 31, 12, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, Route19Trainer2, -1
	person_event SPRITE_BIKER, 36,  6, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 1, Route19Trainer3, -1
	person_event SPRITE_AROMA_LADY, 44, 14, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_GENERICTRAINER, 4, Route19Trainer4, -1
	person_event SPRITE_BIKER, 43, 23, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, Route19Trainer5, -1
	person_event SPRITE_GENTLEMAN, 41, 34, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 3, Route19Trainer6, -1
