Route29_MapScriptHeader:
	...
	coord_event 24, 16, 1, Route29GrassSetup

	db 0 ; bg events

	db 4 ; object events
	person_event SPRITE_GENERAL_VARIABLE_1, 11, 14, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route29Mina, -1
	person_event SPRITE_DISGUISEMAN,  9, 15, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, Route29Easel, -1
	person_event SPRITE_LEAVES,  9, 15, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, Route29Easel, -1
...
.cont3
	...
	moveperson ROUTE_29_MINA, $0f, $0a
