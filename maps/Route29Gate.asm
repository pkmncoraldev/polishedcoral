Route29Gate_MapScriptHeader:
	db 2 ; scene scripts
	scene_script Route29GateTrigger0
	scene_script Route29GateTrigger1

	db 1 ; callbacks
	callback MAPCALLBACK_TILES, Route29GateCallback

	db 4 ; warp events
	warp_event  3,  0, ROUTE_29, 1
	warp_event  4,  0, ROUTE_29, 2
