Route3_MapScriptHeader:
	...
	person_event SPRITE_BATTLE_GIRL, 13, 36, SPRITEMOVEDATA_WANDER, 0, 1, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, TrainerRoute3WestNpc, -1
	person_event SPRITE_PATCHES,  8, 38, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, TrainerRoute3WestPatches, -1
