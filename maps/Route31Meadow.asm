Route31Meadow_MapScriptHeader:
	...
	db 3 ; object events
	person_event SPRITE_GENERAL_VARIABLE_1, 10, 21, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route31Mina, EVENT_ROUTE_31_MINA_GONE
	person_event SPRITE_ICESKATER_VARIABLE,  8, 22, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, Route31Easel, EVENT_ROUTE_31_MINA_GONE
	person_event SPRITE_LEAVES,  8, 22, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, Route31Easel, EVENT_ROUTE_31_MINA_GONE
