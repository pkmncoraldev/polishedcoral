Route5Gate1F_MapScriptHeader:
	...
	object_event  6,  2, SPRITE_PONYTAIL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_COMMAND, pokemart, MARTTYPE_REFRESHMENTS, MART_ROUTE_5_GATE, -1
