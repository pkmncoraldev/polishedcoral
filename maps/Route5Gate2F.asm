Route5Gate2F_MapScriptHeader:
	...
	person_event SPRITE_BOOK_PAPER_POKEDEX,  5,  4, SPRITEMOVEDATA_BINOCULARS, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, ObjectEvent, -1
	person_event SPRITE_BOOK_PAPER_POKEDEX,  5,  6, SPRITEMOVEDATA_BINOCULARS, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, ObjectEvent, -1
