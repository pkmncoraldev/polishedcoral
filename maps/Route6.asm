Route6_MapScriptHeader:
	...
	person_event SPRITE_FISHER, 15, 37, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_GENERICTRAINER, 0, TrainerRoute6_10, -1
	...
	tmhmball_event  19, 2, TM_ATTRACT, EVENT_TM45
