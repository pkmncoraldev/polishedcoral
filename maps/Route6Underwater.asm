Route6Underwater_MapScriptHeader:
	...
	bg_event 13, 34, SIGNPOST_ITEM + REVIVE, EVENT_ROUTE_6_UNDERWATER_HIDDEN_CORAL_SHARD
	...
	tmhmball_event 72, 32, TM_ICE_BEAM, EVENT_ROUTE_6_UNDERWATER_ICE_BEAM_TM
	itemball_event 28, 33, PEARL, 1, EVENT_ROUTE_6_UNDERWATER_PEARL_2
	itemball_event 30, 19, CORAL_SHARD, 1, EVENT_ROUTE_6_UNDERWATER_CORAL_SHARD_1
	itemball_event 66, 17, CORAL_SHARD, 1, EVENT_ROUTE_6_UNDERWATER_CORAL_SHARD_2
