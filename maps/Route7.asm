Route7_MapScriptHeader:
	...
	db 2 ; object events
	person_event SPRITE_BALL_CUT_FRUIT, 26, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, Route7Dummy, EVENT_ROUTE_6_POKE_BALL_THUNDERPUNCH
