Route9_MapScriptHeader:
	...
	person_event SPRITE_DODUO, 15, 23, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, RanchDoduo, -1
	...
	itemball_event 32,  3, CARBOS, 1, EVENT_ROUTE_9_POKE_BALL_1
