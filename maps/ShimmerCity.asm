ShimmerCity_MapScriptHeader:
	...
	warp_event 11,  5, SHIMMER_UNDER_BOARDWALK, 21
	warp_event 10,  5, SHIMMER_UNDER_BOARDWALK, 20
	warp_event  9,  5, SHIMMER_UNDER_BOARDWALK, 18
	warp_event  8,  5, SHIMMER_UNDER_BOARDWALK, 17
	warp_event  7,  5, SHIMMER_UNDER_BOARDWALK, 16
	warp_event  6,  8, SHIMMER_UNDER_BOARDWALK, 33
	warp_event  6,  9, SHIMMER_UNDER_BOARDWALK, 34
	warp_event  6, 10, SHIMMER_UNDER_BOARDWALK, 35
	warp_event  7, 12, SHIMMER_UNDER_BOARDWALK, 28
	...
	db 3 ; bg events
	bg_event 21, 17, SIGNPOST_ITEM + BIG_NUGGET, EVENT_SHIMMER_CITY_HIDDEN_ITEM
	signpost 16, 22, SIGNPOST_LEFT, ShimmerCityFishMarket
	signpost 19, 22, SIGNPOST_LEFT, ShimmerCityBerryMarket

	db 10 ; object events
	person_event SPRITE_FISHING_GURU, 16, 21, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, ShimmerCityNpc1, -1
	person_event SPRITE_POKEFAN_F, 19, 21, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, ShimmerCityNpc2, -1
	person_event SPRITE_REDS_MOM, 21, 28, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, ShimmerCityNpc3, -1
	person_event SPRITE_CHILD, 16, 30, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, ShimmerCityNpc4, -1
	person_event SPRITE_FAT_GUY, 15, 26, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, ShimmerCityNpc5, -1
	person_event SPRITE_BALLOONS, 17, 23, SPRITEMOVEDATA_BALLOONS_1, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, 0, -1
	person_event SPRITE_BALLOONS, 14, 23, SPRITEMOVEDATA_BALLOONS_2, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, 0, -1
	person_event SPRITE_BOOK_PAPER_POKEDEX, 17, 22, SPRITEMOVEDATA_STALL, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, 0, -1
	person_event SPRITE_BOOK_PAPER_POKEDEX,  5,  8, SPRITEMOVEDATA_BINOCULARS_2, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, 0, -1
	person_event SPRITE_BOOK_PAPER_POKEDEX,  5, 10, SPRITEMOVEDATA_BINOCULARS_2, 0, 0, -1, -1, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, 0, -1
