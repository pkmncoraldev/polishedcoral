StarglowCavern2F_MapScriptHeader:
	...
	person_event SPRITE_POKEMANIAC, 13, 20, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, StarglowCavern2FNPC1, -1
	tmhmball_event 23, 16, TM_METAL_CLAW, 1, EVENT_STARGLOW_CAVERN_2F_POKE_BALL1
