...
;	signpost 8, 14, SIGNPOST_READ, StarglowClue
	...
	person_event SPRITE_COOLTRAINER_F, 18, 12, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 1, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, StarglowLass2, EVENT_PUNKS_HAVENT_LEFT_STARGLOW
