SunbeamBeach_MapScriptHeader:
	...
	db 1 ; bg events
	bg_event  4, 20, SIGNPOST_ITEM + WATER_STONE, EVENT_SUNBEAM_BEACH_HIDDEN_WATER_STONE

	db 11 ; object events
	person_event SPRITE_CANDLE, 29, 10, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, 1<<NITE, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, SunbeamIslandSunbatherNite, -1
	person_event SPRITE_CANDLE, 29, 10, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, 1<<DUSK, (1 << 3) | PAL_OW_SILVER, PERSONTYPE_SCRIPT, 0, SunbeamIslandSunbatherNite, -1
