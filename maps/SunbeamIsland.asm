SunbeamIsland_MapScriptHeader:
	...
	signpost 47,  1, SIGNPOST_ITEM + BOTTLE_CAP, EVENT_SUNBEAM_ISLAND_HIDDEN_BOTTLE_CAP_2
	signpost 43, 15, SIGNPOST_ITEM + BOTTLE_CAP, EVENT_SUNBEAM_ISLAND_HIDDEN_BOTTLE_CAP_3
	signpost 44, 33, SIGNPOST_ITEM + BOTTLE_CAP, EVENT_SUNBEAM_ISLAND_HIDDEN_BOTTLE_CAP_4
	...
	person_event SPRITE_PONYTAIL, 44, 26, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_TEAL, PERSONTYPE_SCRIPT, 0, SunbeamCrowd, EVENT_SUNBEAM_CROWD_GONE
	...
	person_event SPRITE_FLOATING_BALL, 48, 39, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, SunbeamFloatingBall1, EVENT_SUNBEAM_FLOATING_BALL_1
