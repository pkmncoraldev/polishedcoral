SunbeamIslandEast_MapScriptHeader:
	...
	person_event SPRITE_FLOATING_BALL, 54,  6, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, SunbeamFloatingBall2, EVENT_SUNBEAM_FLOATING_BALL_2
...
SunbeamFloatingBall2:
	...
	iffalse .end
	setevent EVENT_SUNBEAM_FLOATING_BALL_2
.end
	end
