SunbeamJungle_MapScriptHeader:
	...
	person_event SPRITE_SNARE, 26, 18, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_GENERICTRAINER, 4, SunbeamJungleSnare4, EVENT_SAVED_SUNBEAM
