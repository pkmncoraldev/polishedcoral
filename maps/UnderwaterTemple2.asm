UnderwaterTemple2_MapScriptHeader:
	...
	db 2 ; object events
	object_event  9, 25, SPRITE_MON_ICON, SPRITEMOVEDATA_STANDING_DOWN, 0, CORSOLA, -1, -1, PAL_NPC_BROWN, PERSONTYPE_SCRIPT, 0, UnderwaterTemple2Corsola, EVENT_UNDERWATER_TEMPLE_2_CORSOLA
